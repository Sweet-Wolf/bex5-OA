...
<has-relation relation="fTimePeriod" data-type="String"></has-relation>
<has-relation relation="fScheDay" data-type="String"></has-relation>
<has-relation relation="fIsTitle" data-type="String"></has-relation>
<has-relation relation="fScheID" data-type="String"></has-relation>
</concept>  
...
<relation name="fTimePeriod" data-type="String"><label language="zh_CN">日程时间段</label>
</relation>
<relation name="fScheDay" data-type="String"><label language="zh_CN">日程日</label>
</relation>
<relation name="fIsTitle" data-type="String"><label language="zh_CN">是否标题</label>
</relation>
<relation name="fScheID" data-type="String"><label language="zh_CN">日程ID</label>
</relation>
</model>
