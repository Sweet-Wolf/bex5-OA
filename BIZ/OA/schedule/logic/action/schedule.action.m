<?xml version="1.0" encoding="utf-8" standalone="no"?><model xmlns="http://www.justep.com/model">  
  ...
  <action name="queryOA_ScheduleMonthAction" procedure="queryOA_ScheduleMonthProcedure">
    <permission name="range" type="List"/>  
...
<public name="schePerson" type="String"/>

</action> 
<action name="schedulePortalAction" global="false" procedure="schedulePortalProcedure"><label language="zh_CN">日程portal</label>
</action>
</model>