...
<task-relation-value><item relation="sEURL">'/OA/finance/process/financeLoanApply/noticeActivity.a'</item>
...
<has-action action="createFCLoanApplyAction" access-permission="public"></has-action>
<has-action action="queryFCLoanApplyAction" access-permission="public"></has-action>
<has-action action="saveFCLoanApplyAction" access-permission="public"></has-action>
