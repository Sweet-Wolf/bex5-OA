...
<item relation="sName">concat('【',currentProcessLabelOfProcessContext(),':',currentActivityLabelOfProcessContext(),'】','报销人： ',relationValue('OA_FC_ReimbApplyM',:sData1,'','','fLoanPsnName','/OA/finance/data'),'（报销金额：',toString(relationValue('OA_FC_ReimbApplyM',:sData1,'','','fReimAmt','/OA/finance/data')),'元）','单号： ',relationValue('OA_FC_ReimbApplyM',:sData1,'','','fNO','/OA/finance/data'))
    ...
    <notice-rule condition="true" dialog-enabled="true" save-enabled="false" task-assign-mode="together"> 
      ...
      <task-relation-value> 
        ...
        <item relation="sEURL">'/OA/finance/process/financeReimbrseApply/noticeActivity.a'</item>  
        <item relation="sExecuteMode">'temPreempt'</item>  
...
<has-action action="createFCReimbApplyMAction" access-permission="public"></has-action>
<has-action action="queryFCReimbApplyMAction" access-permission="public"></has-action>
<has-action action="saveFCReimbApplyMAction" access-permission="public"></has-action>
<has-action action="createFCReimbApplyDAction" access-permission="public"></has-action>
<has-action action="queryFCReimbApplyDAction" access-permission="public"></has-action>
<has-action action="saveFCReimbApplyDAction" access-permission="public"></has-action>
...
<has-action action="sqlQueryAction" access-permission="public"><public name="dataModel" type="String" value="/OA/finance/data"></public>
</has-action>
