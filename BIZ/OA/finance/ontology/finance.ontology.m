...
<model xmlns="http://www.justep.com/model">  
  ...
  <concept name="OA_FC_LoanApply" default-value-expr="guid()"> 
    ...
    <has-relation relation="fLoanAmt" data-type="Decimal"/>  
    ...
    <has-relation relation="fExtendStr1" data-type="String" size="64" unique="false"><label language="zh_CN">扩展字段</label>
</has-relation>
...
<has-relation relation="fExtendNum5" data-type="Decimal" size="18" scale="4"><label language="zh_CN">扩展字段</label>
  ...
  <concept name="OA_FC_ReimbApplyM" default-value-expr="guid()"> 
    <has-relation relation="version" default-value-expr="0" size="1024"/>  
    <has-relation relation="fNO" default-value-expr="nextSeqString(format('BXSQ-%1$tY%1$tm%1$td-', currentDateTime()),'0000')" size="36"/>  
    <label language="zh_CN">报销申请(主表)</label>  
    <has-relation relation="fLoanOgnID" default-value-expr="currentOgnID()" size="36"> 
      <label language="zh_CN">报销机构ID</label>  
    </has-relation>  
    <has-relation relation="fLoanOgnName" default-value-expr="currentOgnName()" size="64"> 
      <label language="zh_CN">报销机构</label>  
    </has-relation>  
    <has-relation relation="fLoanDeptID" default-value-expr="if(currentDeptID() = null, currentOgnID(), currentDeptID())" size="36"> 
      <label language="zh_CN">报销部门ID</label>  
    </has-relation>  
    <has-relation relation="fLoanDeptName" default-value-expr="if(currentDeptName() = null, currentOgnName(), currentDeptName())" size="64"> 
      <label language="zh_CN">报销部门</label>  
    </has-relation>  
    <has-relation relation="fLoanPosID" default-value-expr="currentPosID()" size="36"> 
      <label language="zh_CN">报销岗位ID</label>  
    </has-relation>  
    <has-relation relation="fLoanPosName" default-value-expr="currentPosName()" size="64"> 
      <label language="zh_CN">报销岗位</label> 
    </has-relation>  
    <has-relation relation="fLoanPsnID" default-value-expr="currentPersonID()" size="64"> 
      <label language="zh_CN">报销人员ID</label> 
    </has-relation>  
    <has-relation relation="fLoanPsnName" default-value-expr="currentPersonName()" size="64"> 
      <label language="zh_CN">报销人员</label> 
    </has-relation>  
    <has-relation relation="fLoanPsnFullID" default-value-expr="currentPersonMemberFID()" size="1024"> 
      <label language="zh_CN">报销人员FullID</label> 
    </has-relation>  
    <has-relation relation="fLoanPsnFullName" default-value-expr="currentPersonMemberFName()" size="64"> 
    ...
    <has-relation relation="fClienter" size="64"/>  
    <has-relation relation="fReimAmt" data-type="Decimal" size="64"/>  
    <has-relation relation="fMustReimAmt" data-type="Decimal" default-value-expr="0.0"> 
      <label language="zh_CN">实报金额</label> 
    </has-relation>  
    <has-relation relation="fCreatePsnID" default-value-expr="currentPersonID()" size="36"/>  
    <has-relation relation="fCreatePsnName" default-value-expr="currentPersonName()" size="36"/>  
    <has-relation relation="fCreatePsnFID" default-value-expr="currentPersonMemberFID()" size="1024"/>  
    <has-relation relation="fCreatePsnFName" default-value-expr="currentPersonMemberFName()" size="36"/>  
    <has-relation relation="fCreateTime" default-value-expr="currentDateTime()"/>  
    ...
    <has-relation relation="fReiEvent" data-type="String" size="1024"/>  
    <has-relation relation="fReiAllowance" data-type="Decimal"/>  
    <has-relation relation="fRemark" size="1024"/>  
    <has-relation relation="fIsPreLoan" size="64"/>  
    <has-relation relation="fLoanAmt" default-value-expr="0.0" data-type="Decimal" size="64"/>  
    <has-relation relation="fBizState" default-value-expr="'bsEditing'" size="1024"/>  
    <has-relation relation="fBizStateName" default-value-expr="'编辑中'" size="1024"/>  
    <has-relation relation="fCreateOgnID" default-value-expr="currentOgnID()" size="64"/>  
    <has-relation relation="fCreateOgnName" default-value-expr="currentOgnName()" size="64"/>  
    <has-relation relation="fCreateDeptID" default-value-expr="if(currentDeptID() = null, currentOgnID(), currentDeptID())" size="64"/>  
    ...
    <has-relation relation="fCreatePosName" default-value-expr="currentPosName()" size="36"/>  
  ...
  <has-relation relation="fOughtReimbAmtCn" data-type="String" size="64"><label language="zh_CN">实报金额大写</label>
</has-relation>
<has-relation relation="fExtendStr1" data-type="String" size="1024"><label language="zh_CN">扩展字段</label>
</has-relation>
<has-relation relation="fExtendStr2" data-type="String" size="1024"><label language="zh_CN">扩展字段</label>
</has-relation>
<has-relation relation="fExtendStr3" data-type="String" size="64"><label language="zh_CN">扩展字段</label>
</has-relation>
<has-relation relation="fExtendStr4" data-type="String" size="64"><label language="zh_CN">扩展字段</label>
