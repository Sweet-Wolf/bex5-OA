...
<task-relation-value><item relation="sExecuteMode">'temPreempt'</item>
<item relation="sName">concat('【',currentProcessLabelOfProcessContext(),':',currentActivityLabelOfProcessContext(),'】','申请部门： ',relationValue('OA_OSC_UseApplyM',:sData1,'','','fApplyDeptName','/OA/officeSupplyConsumables/data'),'（需求日期：',toString(relationValue('OA_OSC_UseApplyM',:sData1,'','','fDemandDate','/OA/officeSupplyConsumables/data')),'）','单号： ',relationValue('OA_OSC_UseApplyM',:sData1,'','','fNO','/OA/officeSupplyConsumables/data'))</item>
...
<task-relation-value><item relation="sEURL">'/OA/officeSupplyConsumables/process/officeSupplyUseApply/noticeActivity.a'</item>
...
<has-action action="createOSCUseApplyMAction" access-permission="public"></has-action>
<has-action action="queryOSCUseApplyMAction" access-permission="public"></has-action>
<has-action action="saveOSCUseApplyMAction" access-permission="public"></has-action>
<has-action action="createOSCUseApplyDAction" access-permission="public"></has-action>
<has-action action="queryOSCUseApplyDAction" access-permission="public"></has-action>
<has-action action="saveOSCUseApplyDAction" access-permission="public"></has-action>
<has-action action="queryOSCBaseInfoAction" access-permission="public"></has-action>
<has-action action="canUseAction" access-permission="public"></has-action>
