...
<model xmlns="http://www.justep.com/model">  
  ...
  <concept name="OA_DC_Doc" default-value-expr="guid()"> 
    ...
    <has-relation relation="fDocNumber" size="128"><label language="zh_CN">发文编号</label>
</has-relation>  
    ...
    <has-relation relation="fSponsorDept" size="1024"><label language="zh_CN">拟办单位</label>
</has-relation>  
    <has-relation relation="fDocExigenceLevel" size="36"/>  
    <has-relation relation="fDocExigenceLevelCode" size="64"/>  
    <has-relation relation="fDocExigenceLevelName" size="64"><label language="zh_CN">快慢等级</label>
</has-relation>  
    <has-relation relation="fDocSecretLevel" size="36"/>  
    <has-relation relation="fDocSecretLevelCode" size="64"/>  
    <has-relation relation="fDocSecretLevelName" size="64"><label language="zh_CN">密级</label>
</has-relation>  
    <has-relation relation="fOrgLetter" size="36"/>  
    <has-relation relation="fOrgLetterCode" size="64"/>  
    <has-relation relation="fOrgLetterName" size="64"><label language="zh_CN">机关代字</label>
</has-relation>  
    ...
    <has-relation relation="fMainDestDept" size="1024"><label language="zh_CN">主 送</label>
</has-relation>  
    <has-relation relation="fCopyDestDeptID" size="1024"/>  
    <has-relation relation="fCopyDestDept" size="1024"><label language="zh_CN">抄送</label>
</has-relation>  
    ...
    <has-relation relation="fCheckPerID" size="36" default-value-expr="currentPersonName()"/>  
    <has-relation relation="fCheckPerName" size="64" default-value-expr="currentPersonName()"><label language="zh_CN">核 稿</label>
</has-relation>  
    <has-relation relation="fCheckTime" data-type="DateTime"><label language="zh_CN">核稿日期</label>
</has-relation>  
    ...
    <has-relation relation="fTypePerName" size="64"><label language="zh_CN">用 印</label>
</has-relation>  
    ...
    <has-relation relation="fProofReader" size="64"><label language="zh_CN">校 对</label>
</has-relation>  
    ...
    <has-relation relation="fDocKindName"><label language="zh_CN">公文种类</label>
</has-relation>  
    ...
    <has-relation relation="fTemplate" data-type="String"><label language="zh_CN">正 文</label>
</has-relation>  
