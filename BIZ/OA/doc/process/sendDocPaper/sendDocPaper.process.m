  ...
  <process name="sendDocPaperProcess" start="start1" end="end1"> 
    ...
    <business-activity name="draftActivity" condition="true"> 
      ...
      <execute-rule condition="isStartingProcess()" task-assign-mode="together">
        <executor-range range-expr="currentPersonMember2()" default-expr="currentPersonMember2()">
          <kind>PSM</kind> 
        </executor-range>  
        <task-relation-value>
...
<has-action action="checkOrgNumAction" access-permission="public"></has-action>
