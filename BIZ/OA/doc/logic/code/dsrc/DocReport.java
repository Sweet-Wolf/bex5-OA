...
public class DocReport {
	public static Table docSummaryFW(String beginDate,String endDate,String dayNum,String orgIDs)throws DocumentException{
		...
		if(dayNum.equals("") || dayNum.equals(null)){
			...
			mySql ="select t1.SWSPCT,t2.QQWBJWSCT,t3.DQXSWSCT,t4.BJSLCT,t5.QQZJRWBJSCT,t6.DQXSWBJCT,t7.WBJCT,null CSBLRWSCT,null ASBLRWCT,null DAYNUM,"+orgID+","+beginDateMySQL+" BEGINDATE,"+endDateMySQL+" ENDDATE from "
			+ "(select (a1.ct+a2.ct) SWSPCT from (select count(d.fid) ct  from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime < "+beginDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateMySQL+"))) a1,(select count(d.fid) ct from  OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and d.fcreatetime >= "+beginDateMySQL+" and d.fcreatetime <= "+endDateMySQL+orgCondition+") a2) t1,"
			+ "(select count(d.fid) QQWBJWSCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime < "+beginDateMySQL+orgCondition+" ) d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateMySQL+"))) t2,"
			+ "(select count(d.fid) DQXSWSCT from  OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and d.fcreatetime >= "+beginDateMySQL+" and d.fcreatetime <= "+endDateMySQL+orgCondition+") t3,"
			+ "(select count(s.sid) BJSLCT from "+dbNameMySQL+".sa_task s where s.sprocess='/OA/doc/process/sendDoc/sendDocProcess' and s.sstatusid = 'tesFinished' and s.sparentid is null and s.sactualfinishtime >= "+beginDateMySQL+" and s.sactualfinishtime <= "+endDateMySQL+") t4,"
			+ "(select count(d.fid) QQZJRWBJSCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime < "+beginDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime >= "+beginDateMySQL+" and s.sactualfinishtime <= "+endDateMySQL+")) t5,"
			+ "(select count(d.fid) DQXSWBJCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime >= "+beginDateMySQL+" and fcreatetime <= "+endDateMySQL+orgCondition+" ) d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime <= "+endDateMySQL+")) t6,"
			+ "(select count(d.fid) WBJCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime <= "+endDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime >= "+endDateMySQL+"))) t7";
		}else{
			...
			mySql = "select t1.SWSPCT,t2.QQWBJWSCT,t3.DQXSWSCT,t4.BJSLCT,t5.QQZJRWBJSCT,t6.DQXSWBJCT,t7.WBJCT,t8.CSBLRWSCT,t9.ASBLRWCT,"+dayNum+" DAYNUM,"+orgID+","+beginDateMySQL+" BEGINDATE,"+endDateMySQL+" ENDDATE from "
			+ "(select (a1.ct+a2.ct) SWSPCT from (select count(d.fid) ct  from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime < "+beginDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateMySQL+"))) a1,(select count(d.fid) ct from  OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and d.fcreatetime >= "+beginDateMySQL+" and d.fcreatetime <= "+endDateMySQL+orgCondition+") a2) t1,"
			+ "(select count(d.fid) QQWBJWSCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime < "+beginDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateMySQL+"))) t2,"
			+ "(select count(d.fid) DQXSWSCT from  OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and d.fcreatetime >= "+beginDateMySQL+" and d.fcreatetime <= "+endDateMySQL+orgCondition+") t3,"
			+ "(select count(s.sid) BJSLCT from "+dbNameMySQL+".sa_task s where s.sprocess='/OA/doc/process/sendDoc/sendDocProcess' and s.sstatusid = 'tesFinished' and s.sparentid is null and s.sactualfinishtime >= "+beginDateMySQL+" and s.sactualfinishtime <= "+endDateMySQL+") t4,"
			...
			+ "(select count(d.fid) DQXSWBJCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime >= "+beginDateMySQL+" and fcreatetime <= "+endDateMySQL+orgCondition+" ) d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime <= "+endDateMySQL+")) t6,"
			+ "(select count(d.fid) WBJCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime <= "+endDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime >= "+endDateMySQL+"))) t7,"
			+ "(select count(d.fid) CSBLRWSCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime >= "+beginDateMySQL+" and fcreatetime <= "+endDateMySQL+orgCondition+" ) d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime > date_add(s.sactualstarttime ,INTERVAL ("+dayNum+"-1) day) )) t8,"
			+ "(select count(d.fid) ASBLRWCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_SendDoc' and fcreatetime >= "+beginDateMySQL+" and fcreatetime <= "+endDateMySQL+orgCondition+" ) d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime <= date_add(s.sactualstarttime ,INTERVAL ("+dayNum+"-1) day))) t9";
	...
	public static Table docSummarySW(String beginDate,String endDate,String dayNum,String orgIDs)throws DocumentException{
		...
		if(dayNum.equals("") || dayNum.equals(null)){
			...
			mySql = "select t1.SWSPCT,t2.QQWBJWSCT,t3.DQXSWSCT,t4.BJSLCT,t5.QQZJRWBJSCT,t6.DQXSWBJCT,t7.WBJCT,null CSBLRWSCT,null ASBLRWCT,null DAYNUM,"+orgID+","+beginDateMySQL+" BEGINDATE,"+endDateMySQL+" ENDDATE from "
			+ "(select (a1.ct+a2.ct) SWSPCT from (select count(d.fid) ct  from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime < "+beginDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateMySQL+"))) a1,(select count(d.fid) ct from  OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and d.fcreatetime >= "+beginDateMySQL+" and d.fcreatetime <= "+endDateMySQL+orgCondition+") a2) t1,"
			+ "(select count(d.fid) QQWBJWSCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime < "+beginDateMySQL+orgCondition+" ) d join "+dbNameORCL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateMySQL+"))) t2,"
			+ "(select count(d.fid) DQXSWSCT from  OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and d.fcreatetime >= "+beginDateMySQL+" and d.fcreatetime <= "+endDateMySQL+orgCondition+") t3,"
			+ "(select count(s.sid) BJSLCT from "+dbNameMySQL+".sa_task s where s.sprocess='/OA/doc/process/receiveDoc/receiveDocProcess' and s.sstatusid = 'tesFinished' and s.sparentid is null and s.sactualfinishtime >= "+beginDateMySQL+" and s.sactualfinishtime <= "+endDateMySQL+") t4,"
			+ "(select count(d.fid) QQZJRWBJSCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime < "+beginDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime >= "+beginDateMySQL+" and s.sactualfinishtime <= "+endDateMySQL+")) t5,"
			+ "(select count(d.fid) DQXSWBJCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime >= "+beginDateMySQL+" and fcreatetime <= "+endDateMySQL+orgCondition+" ) d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime <= "+endDateMySQL+")) t6,"
			+ "(select count(d.fid) WBJCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime <= "+endDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime >= "+endDateMySQL+"))) t7";
		}else{
			orclSql = "select t1.ct SWSPCT,t2.ct QQWBJWSCT,t3.ct DQXSWSCT,t4.ct BJSLCT,t5.ct QQZJRWBJSCT,t6.ct DQXSWBJCT,t7.ct WBJCT,t8.ct CSBLRWSCT,t9.ct ASBLRWCT,"+dayNum+" DAYNUM,"+orgID+","+beginDateOrcl+" BEGINDATE,"+endDateOrcl+" ENDDATE from "
			+ "(select (a1.ct+a2.ct) ct from (select count(d.fid) ct  from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime < "+beginDateOrcl+orgCondition+") d join "+dbNameORCL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateOrcl+"))) a1,(select count(d.fid) ct from  OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and d.fcreatetime >= "+beginDateOrcl+" and d.fcreatetime <= "+endDateOrcl+orgCondition+") a2) t1,"
			+ "(select count(d.fid) ct from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime < "+beginDateOrcl+orgCondition+") d join "+dbNameORCL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateOrcl+"))) t2,"
			...
			mySql = "select t1.SWSPCT,t2.QQWBJWSCT,t3.DQXSWSCT,t4.BJSLCT,t5.QQZJRWBJSCT,t6.DQXSWBJCT,t7.WBJCT,t8.CSBLRWSCT,t9.ASBLRWCT,"+dayNum+" DAYNUM,"+orgID+","+beginDateMySQL+" BEGINDATE,"+endDateMySQL+" ENDDATE from "
			+ "(select (a1.ct+a2.ct) SWSPCT from (select count(d.fid) ct  from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime < "+beginDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateMySQL+"))) a1,(select count(d.fid) ct from  OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and d.fcreatetime >= "+beginDateMySQL+" and d.fcreatetime <= "+endDateMySQL+orgCondition+") a2) t1,"
			+ "(select count(d.fid) QQWBJWSCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime < "+beginDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime > "+beginDateMySQL+"))) t2,"
			+ "(select count(d.fid) DQXSWSCT from  OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and d.fcreatetime >= "+beginDateMySQL+" and d.fcreatetime <= "+endDateMySQL+orgCondition+") t3,"
			+ "(select count(s.sid) BJSLCT from "+dbNameMySQL+".sa_task s where s.sprocess='/OA/doc/process/receiveDoc/receiveDocProcess' and s.sstatusid = 'tesFinished' and s.sparentid is null and s.sactualfinishtime >= "+beginDateMySQL+" and s.sactualfinishtime <= "+endDateMySQL+") t4,"
			+ "(select count(d.fid) QQZJRWBJSCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime < "+beginDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime >= "+beginDateMySQL+" and s.sactualfinishtime <= "+endDateMySQL+")) t5,"
			+ "(select count(d.fid) DQXSWBJCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime >= "+beginDateMySQL+" and fcreatetime <= "+endDateMySQL+orgCondition+" ) d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime <= "+endDateMySQL+")) t6,"
			+ "(select count(d.fid) WBJCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime <= "+endDateMySQL+orgCondition+") d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid <> 'tesFinished' or (s.sstatusid = 'tesFinished' and s.sactualfinishtime >= "+endDateMySQL+"))) t7,"
			+ "(select count(d.fid) CSBLRWSCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime >= "+beginDateMySQL+" and fcreatetime <= "+endDateMySQL+orgCondition+" ) d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime > date_add(s.sactualstarttime ,INTERVAL ("+dayNum+"-1) day) )) t8,"
			+ "(select count(d.fid) ASBLRWCT from (select fid from OA_DC_Doc d  where fDocType='OA_DC_ReceiveDoc' and fcreatetime >= "+beginDateMySQL+" and fcreatetime <= "+endDateMySQL+orgCondition+" ) d join "+dbNameMySQL+".sa_task s on d.fid=s.sdata1 and s.sparentid is null and (s.sstatusid = 'tesFinished' and s.sactualfinishtime <= date_add(s.sactualstarttime ,INTERVAL ("+dayNum+"-1) day))) t9";
	...
	public static Table receiveDocRpt(String docID){
		String ksql = "select a.fTitle,a.fKeyword,a.fDocNumber,a.fSourceDept, a.fSourceDocNumber,"
					 +"a.fSponsorDept,a.fDocExigenceLevel,a.fDocExigenceLevelName,a.fOrgLetterName,a.fSourceSortName,"
				     +"a.fIssueDate, a.fCopies,a.fPages,a.fContent,a.fMainDestDept,a.fCopyDestDept,"
					 +"a.fDocSecretLevelName, a.fSourceDate,a.fYear,a.fMonth,a.fDocKindName,a.fExtendStr1"
				     +" from OA_DC_Doc a where a ='"+docID+"'";
	//	Map<String, Object> variables = new HashMap<String, Object>();
		//variables.put("id", id);
		return KSQL.select(ksql, null, "/OA/doc/data", null);
	}
	

	public static Table receiveDocRptDetail(String docID){
		String orclSql = "",msSql = "",mySql="";
		orclSql =  "select FACTIVITYLABEL,FOPINION,FCREATEPSNNAME,FCREATETIME "
		          +" from OA_PUB_Execute where FMasterID='"+docID+"' and fCreateOgnID is not null order by fCreateTime asc";
		msSql = orclSql;
		mySql = orclSql;
