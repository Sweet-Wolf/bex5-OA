...
<item relation="sName">concat('【',currentProcessLabelOfProcessContext(),':',currentActivityLabelOfProcessContext(),'】','借阅人： ',relationValue('OA_AM_BorrowApplyM',:sData1,'','','fBorrowPsnName','/OA/archival/data'),'（借阅时间：',toString(relationValue('OA_AM_BorrowApplyM',:sData1,'','','fBorrowTime','/OA/archival/data')),'）')
    ...
    <notice-rule condition="true" dialog-enabled="true" save-enabled="false" task-assign-mode="singleness"> 
      ...
      <task-relation-value> 
        <item relation="sEURL">'/OA/archival/process/archivalBorrowApply/noticeActivity.a'</item>  
  ...
  <has-action action="createAMBorrowApplyMAction" access-permission="public"></has-action>
<has-action action="queryAMBorrowApplyMAction" access-permission="public"></has-action>
<has-action action="saveAMBorrowApplyMAction" access-permission="public"></has-action>
<has-action action="createAMBorrowApplyDAction" access-permission="public"></has-action>
<has-action action="queryAMBorrowApplyDAction" access-permission="public"></has-action>
<has-action action="saveAMBorrowApplyDAction" access-permission="public"></has-action>
<has-action action="queryAMBorrowApplyDWithArchivalAction" access-permission="public"></has-action>
<has-action action="queryAMArchivalAction" access-permission="public"></has-action>
<has-action action="getBorrowInfoAction" access-permission="public"></has-action>
