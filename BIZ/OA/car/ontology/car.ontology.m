...
<model xmlns="http://www.justep.com/model">  
  ...
  <concept name="OA_CA_CarBasicInfo" default-value-expr="guid()"> 
    ...
    <has-relation relation="fCode"><label language="zh_CN">车牌号码</label>
</has-relation>  
    <has-relation relation="fName"><label language="zh_CN">品 牌</label>
</has-relation>  
    ...
    <has-relation relation="fCarDriverName"><label language="zh_CN">配备司机</label>
</has-relation>  
    ...
    <has-relation relation="fUseStatusName" default-value-expr="'未启用'"><label language="zh_CN">状 态</label>
</has-relation>  
  ...
  <concept name="OA_CA_DriverBasicInfo" default-value-expr="guid()"> 
    ...
    <has-relation relation="fCarKindID"/>  
    <has-relation relation="fCarKindName"><label language="zh_CN">准驾车型</label>
</has-relation>  
    <has-relation relation="fDrivingYears"/>  
    <has-relation relation="fTelephone"><label language="zh_CN">联系电话</label>
</has-relation>  
    <has-relation relation="fMobilePhone"><label language="zh_CN">手机</label>
</has-relation>  
    <has-relation relation="fAddress"><label language="zh_CN">家庭住址</label>
</has-relation>  
  ...
  <concept name="OA_CA_CarUseApply" default-value-expr="guid()"> 
    ...
    <has-relation relation="fApplyDeptName" default-value-expr="if(currentDeptName() = null, currentOgnName(), currentDeptName())"><label language="zh_CN">用车部门</label>
</has-relation>  
    ...
    <has-relation relation="fApplyPsnName" default-value-expr="operatorName()"><label language="zh_CN">用 车 人</label>
</has-relation>  
  ...
  <concept name="OA_CA_CarRecord" default-value-expr="guid()"> 
    ...
    <has-relation relation="fApplyDeptName"><label language="zh_CN">用车部门</label>
</has-relation>  
    <has-relation relation="fApplyPsnID"/>  
    <has-relation relation="fApplyPsnName"><label language="zh_CN">用 车 人</label>
</has-relation>  
    <has-relation relation="fBeginTime"><label language="zh_CN">发车时间</label>
</has-relation>  
    <has-relation relation="fEndTime"><label language="zh_CN">返回时间</label>
</has-relation>  
    ...
    <has-relation relation="fCreatePosName" default-value-expr="currentPosName()"/>  
    <has-relation relation="fCreatePsnID" default-value-expr="operatorID()"/>  
    <has-relation relation="fCreatePsnName" default-value-expr="operatorName()"><label language="zh_CN">提交人</label>
</has-relation>  
    <has-relation relation="fCreatePsnFID" default-value-expr="currentPersonMemberFID()"/>  
    <has-relation relation="fCreatePsnFName" default-value-expr="currentPersonMemberFName()"/>  
    <has-relation relation="fCreateTime" default-value-expr="currentDateTime()"/>  
    ...
    <has-relation relation="fUpdatePsnName" default-value-expr="operatorName()"/>  
    <has-relation relation="fUpdateTime" default-value-expr="currentDateTime()"/>  
    <has-relation relation="fNO"><label language="zh_CN">用车申请</label>
</has-relation>  
  ...
  <concept name="OA_CA_FeesRegister" default-value-expr="guid()">
    ...
    <has-relation relation="fUsersName" data-type="String">
      <label language="zh_CN">使用人（部门）</label> 
    </has-relation>  
    <has-relation relation="fRemark" data-type="String">
