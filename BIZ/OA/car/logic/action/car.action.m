...
<action name="queryOA_CA_FeesregisterReportAction" global="false" procedure="queryOA_CA_FeesregisterReportProcedure"><label language="zh_CN">用车费用统计</label>
<public type="String" name="year" required="false"></public>
<public type="String" name="month1" required="false"></public>
<public type="String" name="month2" required="false"></public>
</action>

<action name="queryCarUseReportAction" global="false" procedure="queryCarUseReportProcedure"><label language="zh_CN">用车单主表action</label>
<public type="String" name="id" required="true"></public>
</action>
<action name="queryCarUseDetailReportAction" global="false" procedure="queryCarUseDetailReportProcedure"><label language="zh_CN">用车单详细报表action</label>
<public type="String" name="masterId" required="true"></public>
</action>
</model>