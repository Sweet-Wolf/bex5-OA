...
<input name="x" unit="xor2"></input>
    ...
    <notice-rule condition="true" dialog-enabled="true" save-enabled="false" task-assign-mode="together"> 
      ...
      <task-relation-value> 
        ...
        <item relation="sEURL">'/OA/car/process/carUseApply/noticeActivity.a'</item>  
  ...
  <business-activity name="bizActivity1" condition="true"><label language="zh_CN">公司领导审批</label>
...
<has-action action="queryCarUseReportAction" access-permission="public"></has-action>
<has-action action="queryCarUseDetailReportAction" access-permission="public"></has-action>
</process> 
</model>
