...
<model xmlns="http://www.justep.com/model">  
  <process name="officesWorkPlanProcess" start="start1" end="end1"> 
    ...
    <static-activity name="mainActivity"> 
      <label language="zh_CN">处工作计划编制</label> 
    </static-activity>  
    <static-activity name="noticeActivity"> 
      <label language="zh_CN">处工作计划通知</label> 
    </static-activity>  
    <place name="start1"> 
    ...
    <business-activity name="bizActivity2" condition="true"> 
      ...
      <execute-rule condition="true" task-assign-mode="together">
        ...
        <task-relation-value>
          ...
          <item relation="sName">'流程处理:处工作计划编制'</item> 
        </task-relation-value> 
      </execute-rule>  
    ...
    <notice-rule condition="true" dialog-enabled="false" save-enabled="false" task-assign-mode="singleness"> 
      ...
      <task-relation-value> 
        <item relation="sEURL">'/OA/workPlan/process/officesWorkPlan/noticeActivity.a'</item>  
        <item relation="sExecuteMode2">'finishWhenOpen'</item>  
        <item relation="sName">'通知:处工作计划审批:已完成'</item> 
      </task-relation-value> 
    </notice-rule>  
    <place name="xor1">
