...
<model xmlns="http://www.justep.com/model">  
  <process name="deptWorkPlanProcess" start="start1" end="end1"> 
    ...
    <static-activity name="mainActivity"> 
      <label language="zh_CN">参谋拟制</label> 
    </static-activity>  
    <static-activity name="noticeActivity"> 
      <label language="zh_CN">部工作计划通知</label> 
    </static-activity>  
    <place name="start1"> 
...
<output name="x" unit="deptEdActivity"></output>
    ...
    <notice-rule condition="true" dialog-enabled="false" save-enabled="false" task-assign-mode="singleness">
      ...
      <task-relation-value>
        <item relation="sEURL">'/OA/workPlan/process/deptWorkPlan/noticeActivity.a'</item>  
        <item relation="sExecuteMode2">'finishWhenOpen'</item>  
        <item relation="sName">'通知:部工作计划:已完成'</item> 
      </task-relation-value> 
    </notice-rule> 
...
<model xmlns="http://www.justep.com/model">  
  <process name="deptWorkPlanProcess" start="start1" end="end1"> 
    <label language="zh_CN">部工作计划编制</label>  
    <static-activity name="mainActivity"> 
      <label language="zh_CN">参谋拟制</label> 
    </static-activity>  
    <static-activity name="noticeActivity"> 
    ...
    <business-activity name="deptEdActivity" condition="true"> 
      <label language="zh_CN">参谋拟制</label>  
      <input name="x" unit="start1"/>  
      <output name="x" unit="manageActivity"/> 
    </business-activity>  
    <business-activity name="manageActivity" condition="true"> 
      <label language="zh_CN">部长审批</label>  
      <input name="x" unit="deptEdActivity"/>  
      <output name="x" unit="end1"/>  
      <advance-rule condition="true" dialog-enabled="false" save-enabled="false" jump-enabled="false"
       ignore-execute-mode="false" task-wait="false" task-join="false"/> 
    </business-activity>  
    <place name="end1"> 
      <label language="zh_CN">结束</label> 
    </place>  
