...
public class BoardRoomArrange {
	...
	public static String newMeetingArrangeByApply(String applyID, boolean addScheduleFlag) throws Exception {
		...
		String sql = "select a.fBoardroomID,a.fBoardroom,a.fArrBoardroomID,a.fArrBoardroom,a.fBoardroom,dateTimeToString(a.fBeginTime) as fBeginTime,dateTimeToString(a.fEndTime) as fEndTime," +
				"dateTimeToString(a.fArrBeginTime) as fArrBeginTime,dateTimeToString(a.fArrEndTime) as fArrEndTime,a.fApplyOgnID,a.fApplyOgnName,a.fApplyDeptID,a.fApplyDeptName," 
			...
			+"a.fArrPsnID,a.fArrPsnName,a.fArrPsnFID,a.fArrPsnFName,dateTimeToString(a.fArrTime) as fArrTime,a.fDescription,a.fArrRemark from OA_MT_UseApply a where a='"+applyID+"'";
	
		Table table = KSQL.select(sql, null, OADataModel, null);
		Iterator<Row> rows = table.iterator();
		if (rows.hasNext()) {
			Row rs = rows.next();
			String checkMeetingRoomUseFlag = "false";
			if(rs.getString("fArrBeginTime")!=null && "".equals(rs.getString("fArrBeginTime"))&& rs.getString("fArrEndTime")!=null && "".equals(rs.getString("fArrEndTime"))){
				checkMeetingRoomUseFlag = checkBoardroomUsed(rs.getString("fArrBoardroomID"), rs.getString("fArrBeginTime"),
...
//			fBoardRoom.setText(rs.getString("fArrBoardroom"));
			...
			fEndTime.setText(rs.getString("fArrEndTime"));
			...
			fArrTime.setText(rs.getString("fArrTime"));
