...
<item relation="sName">'会议室使用申请:会议室使用申请'</item>
</task-relation-value>
</execute-rule>
</business-activity>  
...
<task-relation-value><item relation="sPreemptMode">'tpmOpen'</item>
<item relation="sExecuteMode">'temPreempt'</item>
<item relation="sName">'会议室使用审批:会议室使用申请'</item>
</task-relation-value>
</execute-rule>
</business-activity>  
...
<execute-rule condition="true" task-assign-mode="together"><executor-range range-expr="findOrgUnitsHasCActivity(currentDeptFID(), true)" default-expr=""></executor-range>
<task-relation-value><item relation="sPreemptMode">'tpmOpen'</item>
<item relation="sExecuteMode">'temPreempt'</item>
<item relation="sName">'会议室使用安排:会议室使用申请'</item>
</task-relation-value>
</execute-rule>
</business-activity>  
    <place name="end1">
