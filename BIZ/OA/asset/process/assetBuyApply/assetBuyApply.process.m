...
<item relation="sName">concat('【',currentProcessLabelOfProcessContext(),':',currentActivityLabelOfProcessContext(),'】','申请人： ',relationValue('OA_AS_BuyApplyM',:sData1,'','','fApplyPsnName','/OA/asset/data'),'（采购金额：',toString(relationValue('OA_AS_BuyApplyM',:sData1,'','','fAmount','/OA/asset/data')),'元）','单号： ',relationValue('OA_AS_BuyApplyM',:sData1,'','','fNO','/OA/asset/data'))</item>
    ...
    <business-activity name="managerDirectorActivity" condition="true"> 
      <label language="zh_CN">集团领导意见</label>  
...
<task-relation-value><item relation="sEURL">'/OA/asset/process/assetBuyApply/noticeActivity.a'</item>
...
<has-action action="queryOA_AS_BuyApplyDAction" access-permission="public"></has-action>
<has-action action="saveOA_AS_BuyApplyDAction" access-permission="public"></has-action>
<has-action action="createOA_AS_BuyApplyDAction" access-permission="public"></has-action>
</process> 
</model>
