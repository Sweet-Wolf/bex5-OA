...
<task-relation-value><item relation="sEURL">'/OA/asset/process/assetUseApply/noticeActivity.a'</item>
...
<has-action action="createASUseApplyMAction" access-permission="public"></has-action>
<has-action action="queryASUseApplyMAction" access-permission="public"></has-action>
<has-action action="saveASUseApplyMAction" access-permission="public"></has-action>
<has-action action="createASUseArrangeAction" access-permission="public"></has-action>
<has-action action="queryASUseArrangeAction" access-permission="public"></has-action>
<has-action action="saveASUseArrangeAction" access-permission="public"></has-action>
<has-action action="deleteAssetUseArrangeAction" access-permission="public"></has-action>
