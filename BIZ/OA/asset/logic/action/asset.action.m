<?xml version="1.0" encoding="utf-8" standalone="no"?><model xmlns="http://www.justep.com/model">  
  ...
  <action name="queryASSelectBuyApplyAction" procedure="bizQueryProcedure"> 
    ...
    <private name="from" type="String" value="OA_AS_BuyApplyD OA_AS_BuyApplyD optional join OA_AS_BuyApplyM m on OA_AS_BuyApplyD.fMasterID = m optional join OA_Pub_BaseCode k on OA_AS_BuyApplyD.fKindID = k and k.fScope='固定资产类别'"/>  
    <private name="aggregate" type="String"/>  
    <private name="dataModel" type="String" value="/OA/asset/data"/>  
    <private name="fnModel" type="String"/>  
  ...
  <action name="queryASMyAssetAction" procedure="bizQueryProcedure"> 
    <public name="concept" type="String" value="OA_AS_Card"/>  
    <private name="select" type="String" value="OA_AS_Card.*,V_SA_OPPerson.sMainOrgID as sMainOrgID"/>  
    <private name="from" type="String" value="OA_AS_Card OA_AS_Card  join V_SA_OPPerson V_SA_OPPerson on V_SA_OPPerson.sMainOrgID = OA_AS_Card.fDutyOgnID"/>  
    <private name="aggregate" type="String"/>  
    <private name="dataModel" type="String" value="/OA/asset/data"/>  
    <private name="fnModel" type="String"/>  
...
<action name="queryOA_AS_BuyApplyDAction" procedure="bizQueryProcedure"><permission name="range" type="List"/>
<private name="concept" type="String" value="OA_AS_BuyApplyD"/>
<private name="select" type="String" value="OA_AS_BuyApplyD.*"/>
<private name="from" type="String" value="OA_AS_BuyApplyD OA_AS_BuyApplyD"/>
<private name="aggregate" type="String"/>
<private name="dataModel" type="String" value="/OA/asset/data"/>
...
<action name="saveOA_AS_BuyApplyDAction" procedure="bizSaveProcedure"><permission name="insertRange" type="List"/>
<permission name="deleteRange" type="List"/>
<permission name="updateRange" type="List"/>
<private name="concept" type="String" value="OA_AS_BuyApplyD"/>
<private name="dataModel" type="String" value="/OA/asset/data"/>
...
<action name="createOA_AS_BuyApplyDAction" procedure="bizCreateProcedure"><private name="concept" type="String" value="OA_AS_BuyApplyD"/>
<private name="fnModel" type="String"/>
<public name="table" required="true" type="Table"/>
<public name="defaultValues" type="Map"/>
</action>
