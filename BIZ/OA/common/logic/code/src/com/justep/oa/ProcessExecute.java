...
public class ProcessExecute {
	...
	public static void doAfterProcessAction() {
		...
		String dataModel = "";
		String mainConcept = "";
		if(model.getUseableConfig("oa.dataModel")==null){
			dataModel = null;
		}else{
			dataModel = model.getUseableConfig("oa.dataModel").getValue();
		}
		if(model.getUseableConfig("oa.mainConcept")==null){
			mainConcept = null;
		}else{
			mainConcept = model.getUseableConfig("oa.mainConcept").getValue();
		}
