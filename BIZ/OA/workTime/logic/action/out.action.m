<?xml version="1.0" encoding="UTF-8" standalone="no"?><model xmlns="http://www.justep.com/model"><action name="queryOA_WM_outApplyAction" procedure="bizQueryProcedure"><permission name="range" type="List"/>
