...
<model xmlns="http://www.justep.com/model">  
  <process name="evectionProcess" start="start1" end="end1"> 
    ...
    <execute-rule condition="isStartingProcess()" task-assign-mode="together"><executor-range range-expr="currentPersonMember2()" default-expr="currentPersonMember2()"></executor-range>
<task-relation-value><item relation="sPreemptMode">'tpmOpen'</item>
<item relation="sExecuteMode">'temPreempt'</item>
<item relation="sName">'出差申请:出差申请'</item>
</task-relation-value>
</execute-rule>
</business-activity>  
...
<task-relation-value><item relation="sPreemptMode">'tpmOpen'</item>
<item relation="sExecuteMode">'temPreempt'</item>
<item relation="sName">'出差申请审批:出差申请'</item>
</task-relation-value>
</execute-rule>
</business-activity>  
    <place name="end1"> 
...
<has-action action="saveOA_WM_EvecApplyAction" access-permission="public"></has-action>
<has-action action="createOA_WM_EvecApplyAction" access-permission="public"></has-action>
<has-action action="queryOA_WM_eveMemberAction" access-permission="public"></has-action>
<has-action action="saveOA_WM_eveMemberAction" access-permission="public"></has-action>
<has-action action="createOA_WM_eveMemberAction" access-permission="public"></has-action>
...
<has-action action="queryActivityExecutorPersonIDs" access-permission="public"></has-action>
</process> 
</model>
