...
<item relation="sName">'外出申请审批:外出申请'</item>
</task-relation-value>
</execute-rule>
</business-activity>  
...
<has-action action="saveOA_WM_outApplyAction" access-permission="public"></has-action>
<has-action action="createOA_WM_outApplyAction" access-permission="public"></has-action>
<has-action action="queryOA_out_EXECUTEAction" access-permission="public"></has-action>
<has-action action="saveOA_out_EXECUTEAction" access-permission="public"></has-action>
<has-action action="createOA_out_EXECUTEAction" access-permission="public"></has-action>
...
<has-action action="queryOA_WM_outMemberAction" access-permission="public"></has-action>
<has-action action="saveOA_WM_outMemberAction" access-permission="public"></has-action>
<has-action action="createOA_WM_outMemberAction" access-permission="public"></has-action>
