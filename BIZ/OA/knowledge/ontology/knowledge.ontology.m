...
<model xmlns="http://www.justep.com/model">  
  <concept name="OA_KM_Folder" default-value-expr="guid()"> 
    ...
    <has-relation relation="fName" default-value-expr="'新增栏目'"><label language="zh_CN">栏目名称</label>
</has-relation>  
    <has-relation relation="fDescription"><label language="zh_CN">栏目描述</label>
</has-relation>  
    ...
    <has-relation relation="fUseStatusName" default-value-expr="'未启用'"><label language="zh_CN">启用状态</label>
</has-relation>  
...
<has-relation relation="fExtendNum5" data-type="Decimal" size="18" scale="4"><label language="zh_CN">扩展字段</label>
  ...
  <concept name="OA_KM_Knowledge" default-value-expr="guid()"> 
    ...
    <has-relation relation="fTitle"><label language="zh_CN">标 题</label>
</has-relation>  
    <has-relation relation="fKeyword"><label language="zh_CN">主 题 词</label>
</has-relation>  
    <has-relation relation="fDocNumber"/>  
    <has-relation relation="fImportant" default-value-expr="'low'"/>  
    <has-relation relation="fImportantName" default-value-expr="'低'"><label language="zh_CN">重要度</label>
</has-relation>  
    <has-relation relation="fWriter"/>  
    <has-relation relation="fFolderID" data-type="String" default-value-expr="'notice'"/>  
    <has-relation relation="fFolderName" default-value-expr="'公告'"><label language="zh_CN">发布栏目</label>
</has-relation>  
    <has-relation relation="fFolderFullID"/>  
    <has-relation relation="fFolderFullName"><label language="zh_CN">栏目</label>
</has-relation>  
    ...
    <has-relation relation="fTemplateName"><label language="zh_CN">HTML模板</label>
</has-relation>  
    ...
    <has-relation relation="fContent" size="1024"/>  
    ...
    <has-relation relation="fCreateTime" default-value-expr="currentDateTime()"/>  
    <has-relation relation="fReleaseOgnID" size="128"/>  
    <has-relation relation="fReleaseOgnName" size="128"/>  
    <has-relation relation="fReleaseDeptID" size="128"/>  
    <has-relation relation="fReleaseDeptName" size="128"/>  
    <has-relation relation="fReleasePsnID" size="128"/>  
    <has-relation relation="fReleasePsnName" size="128"><label language="zh_CN">发布人</label>
</has-relation>  
    <has-relation relation="fReleasePsnFID" size="1024"/>  
    <has-relation relation="fReleasePsnFName" size="1024"/>  
    <has-relation relation="fReleaseTime"/>  
    <has-relation relation="fReleaseStatus" default-value-expr="'0'"/>  
    <has-relation relation="fReleaseStatusName" default-value-expr="'未发布'" size="128"/>  
    ...
    <has-relation relation="fIsInheritRights" default-value-expr="1"/>  
    <has-relation relation="fOtherFolders"><label language="zh_CN">其他栏目</label>
</has-relation>  
    <has-relation relation="fAttachment" data-type="String" size="1024"/>  
    <has-relation relation="fDocument" data-type="String" size="1024"/>  
    ...
    <has-relation relation="fPicture1" size="1024"/>  
    <has-relation relation="fPicture2" size="1024"/>  
    <has-relation relation="fPicture3" size="1024"/>  
