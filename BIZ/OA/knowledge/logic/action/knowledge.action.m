...
<action name="queryOA_KM_KnowledgeNewsAction" procedure="bizQueryProcedure"><permission name="range" type="List"/>
<private name="concept" type="String" value="OA_KM_Knowledge"/>
<private name="select" type="String" value="OA_KM_Knowledge.fTitle as fTitle,OA_KM_Knowledge.fReleaseTime as fReleaseTime,OA_KM_Knowledge.fReleasePsnID as fReleasePsnID,OA_KM_Knowledge.fReleasePsnName as fReleasePsnName"/>
<private name="from" type="String" value="OA_KM_Knowledge OA_KM_Knowledge"/>
<private name="aggregate" type="String"/>
<private name="dataModel" type="String" value="/OA/knowledge/data"/>
<private name="fnModel" type="String"/>
<protected name="condition" type="String" value="OA_KM_Knowledge in (select  OA_KM_Rights.fKWID from OA_KM_Rights OA_KM_Rights  where  :currentPersonMemberFID() LIKE concat(OA_KM_Rights.fOrgFID, '%') AND OA_KM_Rights.fCanReadKW = 1 AND  not (( OA_KM_Rights.fKWID in (select  OA_KM_READERS.fKWID from OA_KM_READERS OA_KM_READERS  where OA_KM_READERS.fReaderID = :currentPersonID()) )) )  AND ( OA_KM_Knowledge.fFolderID = 'news' OR OA_KM_Knowledge.fFolderFullID LIKE 'public/news%' ) AND OA_KM_Knowledge.fReleaseStatusName = '已发布'"/>
<public name="distinct" type="Boolean" value="false"/>
<public name="idColumn" type="String" value="OA_KM_Knowledge"/>
<public name="filter" type="String"/>
<public name="limit" type="Integer"/>
<public name="offset" type="Integer"/>
<public name="columns" type="String"/>
<public name="orderBy" type="String" value="OA_KM_Knowledge.fReleaseTime desc"/>
<public name="aggregateColumns" type="String"/>
<public name="variables" type="Map"/>
</action>
<action name="queryOA_KM_KnowledgeNoticeAction" procedure="bizQueryProcedure"><permission name="range" type="List"/>
<private name="concept" type="String" value="OA_KM_Knowledge"/>
<private name="select" type="String" value="OA_KM_Knowledge.fTitle as fTitle,OA_KM_Knowledge.fReleaseTime as fReleaseTime"/>
<private name="from" type="String" value="OA_KM_Knowledge OA_KM_Knowledge"/>
<private name="aggregate" type="String"/>
<private name="dataModel" type="String" value="/OA/knowledge/data"/>
<private name="fnModel" type="String"/>
<protected name="condition" type="String" value="OA_KM_Knowledge in (select  OA_KM_Rights.fKWID from OA_KM_Rights OA_KM_Rights  where  :currentPersonMemberFID() LIKE concat(OA_KM_Rights.fOrgFID, '%') AND OA_KM_Rights.fCanReadKW = 1 AND  not (((((((((((( OA_KM_Rights.fKWID in (select  OA_KM_READERS.fKWID from OA_KM_READERS OA_KM_READERS  where OA_KM_READERS.fReaderID = :currentPersonID()) )))))))))))) )  AND ( OA_KM_Knowledge.fFolderID = 'notice' OR OA_KM_Knowledge.fFolderFullID LIKE 'public/notice%' ) AND OA_KM_Knowledge.fReleaseStatusName = '已发布'"/>
<public name="distinct" type="Boolean" value="false"/>
<public name="idColumn" type="String" value="OA_KM_Knowledge"/>
<public name="filter" type="String"/>
<public name="limit" type="Integer"/>
...
<action name="queryOA_KM_KnowledgeDocAction" procedure="bizQueryProcedure"><permission name="range" type="List"/>
<private name="concept" type="String" value="OA_KM_Knowledge"/>
<private name="select" type="String" value="OA_KM_Knowledge.fTitle as fTitle,OA_KM_Knowledge.fReleaseTime as fReleaseTime"/>
<private name="from" type="String" value="OA_KM_Knowledge OA_KM_Knowledge"/>
<private name="aggregate" type="String"/>
<private name="dataModel" type="String" value="/OA/knowledge/data"/>
<private name="fnModel" type="String"/>
<protected name="condition" type="String" value="OA_KM_Knowledge in (select  OA_KM_Rights.fKWID from OA_KM_Rights OA_KM_Rights  where  :currentPersonMemberFID() LIKE concat(OA_KM_Rights.fOrgFID, '%') AND OA_KM_Rights.fCanReadKW = 1 AND  not (((((((((((((( OA_KM_Rights.fKWID in (select  OA_KM_READERS.fKWID from OA_KM_READERS OA_KM_READERS  where OA_KM_READERS.fReaderID = :currentPersonID()) )))))))))))))) )  AND ( OA_KM_Knowledge.fFolderID = 'doc' OR OA_KM_Knowledge.fFolderFullID LIKE 'public/doc%' ) AND OA_KM_Knowledge.fReleaseStatusName = '已发布'"/>
<public name="distinct" type="Boolean" value="false"/>
<public name="idColumn" type="String" value="OA_KM_Knowledge"/>
<public name="filter" type="String"/>
<public name="limit" type="Integer"/>
...
<action name="queryOA_KM_KnowledgeNoReadAction" procedure="bizQueryProcedure"><permission name="range" type="List"/>
<private name="concept" type="String" value="OA_KM_Knowledge"/>
<private name="select" type="String" value="OA_KM_Knowledge.*"/>
<private name="from" type="String" value="OA_KM_Knowledge OA_KM_Knowledge"/>
<private name="aggregate" type="String"/>
<private name="dataModel" type="String" value="/OA/knowledge/data"/>
<private name="fnModel" type="String"/>
<protected name="condition" type="String" value="OA_KM_Knowledge in (select  OA_KM_Rights.fKWID from OA_KM_Rights OA_KM_Rights  where  :currentPersonMemberFID() LIKE concat(OA_KM_Rights.fOrgFID, '%') AND OA_KM_Rights.fCanReadKW = 1 )  AND ( not ((( OA_KM_Knowledge in (select  OA_KM_READERS.fKWID from OA_KM_READERS OA_KM_READERS  where OA_KM_READERS.fReaderID = :currentPersonID()) ))))"/>
<public name="distinct" type="Boolean" value="false"/>
<public name="idColumn" type="String" value="OA_KM_Knowledge"/>
<public name="filter" type="String"/>
<public name="limit" type="Integer"/>
...
<action name="queryOA_KM_KnowledgeReadAction" procedure="bizQueryProcedure"><permission name="range" type="List"/>
<private name="concept" type="String" value="OA_KM_Knowledge"/>
<private name="select" type="String" value="OA_KM_Knowledge.*"/>
<private name="from" type="String" value="OA_KM_Knowledge OA_KM_Knowledge"/>
<private name="aggregate" type="String"/>
<private name="dataModel" type="String" value="/OA/knowledge/data"/>
<private name="fnModel" type="String"/>
<protected name="condition" type="String" value="OA_KM_Knowledge in (select  OA_KM_Rights.fKWID from OA_KM_Rights OA_KM_Rights  where  :currentPersonMemberFID() LIKE concat(OA_KM_Rights.fOrgFID, '%') AND OA_KM_Rights.fCanReadKW = 1 )  AND  OA_KM_Knowledge in (select  OA_KM_READERS.fKWID from OA_KM_READERS OA_KM_READERS  where OA_KM_READERS.fReaderID = :currentPersonID())"/>
<public name="distinct" type="Boolean" value="false"/>
<public name="idColumn" type="String" value="OA_KM_Knowledge"/>
<public name="filter" type="String"/>
<public name="limit" type="Integer"/>
