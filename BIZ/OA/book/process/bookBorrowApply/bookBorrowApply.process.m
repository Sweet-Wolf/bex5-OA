...
<model xmlns="http://www.justep.com/model">  
  <process name="bookBorrowApplyProcess" start="start1" end="end1"> 
    ...
    <listener action="finishProcessAction" event="after" handler="bookBorrowApplyProcessAfterFinishProcedure"/>  
    <has-action action="createBKBookApplyMAction" access-permission="public"/>  
    <has-action action="queryBKBookApplyMAction" access-permission="public"/>  
    <has-action action="saveBKBookApplyMAction" access-permission="public"/>  
    <has-action action="createBookApplyDAction" access-permission="public"/>  
    <has-action action="queryBKBookApplyDAction" access-permission="public"/>  
    <has-action action="saveBKBookApplyDAction" access-permission="public"/>  
    <has-action action="queryBKBookInfoAction" access-permission="public"/>  
    <has-action action="isBookStatusAction" access-permission="public"/>  
    <has-action action="AppendBookAction" access-permission="public"/>  
    <has-action action="queryBKBookApplyDetailAction" access-permission="public"/>  
    <static-activity name="noticeActivity">
      <label language="zh_CN">图书借阅通知</label> 
    </static-activity>  
    <notice-rule condition="true" dialog-enabled="true" save-enabled="false" task-assign-mode="singleness">
      ...
      <executor-range range-expr="findActivityCreator('bookBorrowApplyActivity')" default-expr="findActivityCreator('bookBorrowApplyActivity')">
        <kind>PSM</kind> 
      </executor-range>  
      <task-relation-value>
