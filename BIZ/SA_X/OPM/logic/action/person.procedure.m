...
<model xmlns="http://www.justep.com/model" xmlns:m="http://www.justep.com/model">  
  <procedure name="queryPersonInfoProcedure" code-model="/SA_X/OPM/logic/code" code="OPM.queryPersonInfo"> 
  ...
  <procedure name="queryPersonOrgProcedure" code-model="/SA_X/OPM/logic/code" code="OPM.queryPersonOrg">
    <parameter name="concept" type="String"/>
    <parameter name="idColumn" type="String"/>
    <parameter name="select" type="String"/>
    <parameter name="from" type="String"/>
