...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:334px;top:318px;"
    ...
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="true" concept="OA_VS_Survey" columns="" limit="20"> 
      <reader action="/OA/survey/logic/action/queryVSSurveyAction"/>  
      <writer action="/OA/survey/logic/action/saveVSSurveyAction"/>  
      <creator action="/OA/survey/logic/action/createVSSurveyAction"/>  
  ...
  <div xid="view"> 
    <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
      ...
      <div component="$UI/system/components/justep/smartFilter/smartFilter"
        xid="smartFilter1" filterData="mainData" filterCols="fPerName" class="pull-right"> 
    ...
    <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true"
      ...
      data="mainData" showRowNumber="true" onCellRender="dataTables1CellRender" onRowClick="dataTables1RowClick"> 
      <columns xid="columns1">
        <column name="view" xid="column3" orderable="false" searchable="false"
          label="查看"/>
        <column name="fSState" xid="column6"/>
        <column name="fPerName" xid="column1"/>  
        <column name="fDeptFName" xid="column2"/>  
        <column name="fSendTime" xid="column5"/>
        <column name="fFinishTime" xid="column4"/> 
      </columns>
    </div>
  </div>  
