...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:147px;top:365px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="dataMain"
      concept="OA_BK_BookInfo" autoLoad="true" orderBy="fLoanID asc,fCreateTime desc" directDelete="true"> 
  ...
  <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter"> 
    ...
    <a component="$UI/system/components/justep/button/button" label="查看" class="btn btn-link btn-icon-left" icon="icon-eye" xid="btnShow" onClick="maindataTablesRowDblClick">
   <i class="icon-eye" xid="i1"></i>
