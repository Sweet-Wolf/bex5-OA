...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:160px;top:198px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="dBookInfo"
      concept="OA_BK_BookInfo" autoLoad="true" orderBy="fLoanID asc,fCreateTime desc"> 
    ...
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      ...
      <data xid="default9">[{"id":"0","name":"闲置"},{"id":"1","name":"借出"}]</data>
    </div>
  </div>  
  <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"> 
   ...
   <span xid="span10">查看</span></a><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
    ...
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
      label="申请借阅" xid="btnApply" icon="icon-android-add" onClick="btnApplyClick"> 
      <i xid="i1" class="icon-android-add"/>  
      <span xid="span7">申请借阅</span>
    </a>
  ...
  <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true"
    ...
    data="dBookInfo" showRowNumber="true" onRowDblClick="maindataTablesRowDblClick"
    multiSelect="true"> 
