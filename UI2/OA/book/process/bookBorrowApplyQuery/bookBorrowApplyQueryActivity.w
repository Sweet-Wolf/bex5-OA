...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"> 
    ...
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
      xid="btnShow" label="查看" onClick="maindataTablesRowDblClick" icon="icon-eye"> 
      <i xid="i1" class="icon-eye"/>  
      <span xid="span7">查看</span> 
    </a>  
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
    ...
    <div component="$UI/system/components/justep/orgFilter/orgFilter" xid="orgFilter"
      class="x-control" autoRefresh="true" filterData="dBookApplyM" orgFIDCol="fCreatePsnFID"
      personIDCol="fCreatePsnID" defaultValue="_myself_" useMyself="true"> 
      <div class="x-gridSelect" component="$UI/system/components/justep/org/orgSelectPC"
        xid="orgSelectPC1" multiselect="true" style="width:140px;" manageCodes="bookManagement"> 
        <option xid="option3"> 
