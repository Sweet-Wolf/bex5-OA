...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:pc" xmlns:xui="http://www.justep.com/xui">  
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad" style="height:auto;left:303px;top:6px;"><div autoLoad="true" autoNew="false" columns="" component="$UI/system/components/justep/data/bizData" concept="OA_WM_EvecApply" directDelete="true" orderBy="" xid="mainData" xui:update-mode="merge" onValueChanged="mainDataValueChanged" onBeforeSave="mainDataBeforeSave" onSaveCommit="mainDataSaveCommit">
   ...
   <col name="fSTARTTIME" xid="ruleCol2">
    <required xid="required1">
     <expr xid="default2"></expr></required> 
   ...
   <col name="fFACTSTARTTIME" xid="ruleCol14">
    <readonly xid="readonly14">
     <expr xid="default18"></expr></readonly> </col> 
   <col name="fFACTENDTIME" xid="ruleCol15">
    <readonly xid="readonly15">
     <expr xid="default19"></expr></readonly> </col> 
   <col name="fMODENAME" xid="ruleCol16">
    <readonly xid="readonly16">
     <expr xid="default20">true</expr></readonly> </col> 
   <col name="fMODEID" xid="ruleCol17">
    <readonly xid="readonly17">
     <expr xid="default21">true</expr></readonly> </col> 
   <col name="fAPPLYDEPTNAME" xid="ruleCol18">
    <readonly xid="readonly18">
     <expr xid="default22">true</expr></readonly> </col> 
   <col name="fBizStateName" xid="ruleCol19">
    <readonly xid="readonly19">
     <expr xid="default23">true</expr></readonly> </col> 
   <col name="fCreatePerName" xid="ruleCol20">
    <readonly xid="readonly20">
     <expr xid="default24">true</expr></readonly> </col> 
   <col name="fCreateTime" xid="ruleCol21">
    <readonly xid="readonly21">
     <expr xid="default25">true</expr></readonly> </col> </rule></div></div> 
<div xid="view">
   <div class="x-toolbar x-toolbar-spliter form-inline" component="$UI/system/components/justep/toolBar/toolBar" xid="mainBar">
    <a class="btn btn-link btn-icon-left" component="$UI/system/components/justep/button/button" onClick="{operation:'mainData.save'}" xid="saveBtn" label="保存">
     <i xid="i1"></i>
   ...
   <div xid="content">
    <div class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form" xid="mainForm">
     <div class="row" component="$UI/system/components/bootstrap/row/row" xid="row2" xui:before="row1" xui:parent="mainForm" xui:update-mode="insert" >
<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col511_3" >
...
<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col411_3" >
...
<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col711_3" >
...
<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col611_3" >
...
<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col811_3" >
...
<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col911_3" >
...
<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col1111_3" >
...
<div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col1011_3" >
...
<div class="col col-xs-12 col-sm-6 col-md-6 col-lg-8" xid="col1">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit1">
        ...
        <div class="x-edit" xid="div1"></div></div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col4">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit19">
        ...
        <div class="x-edit" xid="div20">
         <div bind-ref="mainData.ref('fNO')" class="x-output form-control" component="$UI/system/components/justep/output/output" xid="output1"></div></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col5">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit20">
        ...
        <div class="x-edit" xid="div21">
         <input component="$UI/system/components/justep/input/input" class="form-control" xid="input1" bind-ref="mainData.ref('fAPPLYDEPTNAME')"></input></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col6">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit2">
        ...
        <div class="x-edit" xid="div2">
         <input component="$UI/system/components/justep/input/input" class="form-control" xid="input13" bind-ref="mainData.ref('fAPPLYPERSONNAME')"></input></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col7">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit4">
        ...
        <div class="x-edit" xid="div3">
         <input bind-ref="mainData.ref('fAPPLYDATE')" class="form-control" component="$UI/system/components/justep/input/input" xid="input2"></input></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col8">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit3">
        ...
        <div class="x-edit" xid="div4">
         <input bind-ref="mainData.ref('fSTARTTIME')" class="form-control" component="$UI/system/components/justep/input/input" xid="input3"></input></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col9">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit8">
        ...
        <div class="x-edit" xid="div6">
         <input bind-ref="mainData.ref('fENDTIME')" class="form-control" component="$UI/system/components/justep/input/input" xid="input4"></input></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col15">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit7">
        ...
        <div class="x-edit" xid="div8">
         <input bind-ref="mainData.ref('fDAYS')" class="form-control" component="$UI/system/components/justep/input/input" xid="input5"></input></div> </div> </div><div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col10">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit5">
        ...
        <div class="x-edit" xid="div7">
         ...
         </div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col16">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit6">
        ...
        <div class="x-edit" xid="div5">
         <input bind-ref="mainData.ref('fPLACE')" class="form-control" component="$UI/system/components/justep/input/input" xid="input10"></input></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col27">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit22">
        ...
        <div class="x-edit" xid="div18">
         <input bind-ref="mainData.ref('fMODENAME')" class="form-control" component="$UI/system/components/justep/input/input" xid="input11"></input></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col29">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit21">
        ...
        <div class="x-edit" xid="div22">
         <input bind-ref="mainData.ref('fNUMBER')" class="form-control" component="$UI/system/components/justep/input/input" xid="input12"></input></div> </div> </div><div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col28">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit17">
        ...
        <div class="x-edit" xid="div19">
         <textarea bind-ref="mainData.ref('fREASON')" class="form-control" component="$UI/system/components/justep/textarea/textarea" xid="textarea1"></textarea></div> </div> </div><div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col30">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit18">
        ...
        <div class="x-edit" xid="div17">
         <textarea bind-ref="mainData.ref('fRemark')" class="form-control" component="$UI/system/components/justep/textarea/textarea" xid="textarea2"></textarea></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col33">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit25">
        ...
        <div class="x-edit" xid="div26">
         <input bind-ref="mainData.ref('fCreatePerName')" class="form-control" component="$UI/system/components/justep/input/input" xid="input8"></input></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col32">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit23">
        ...
        <div class="x-edit" xid="div25">
         <input bind-ref="mainData.ref('fCreateTime')" class="form-control" component="$UI/system/components/justep/input/input" xid="input7"></input></div> </div> </div><div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col34">
       <div class="x-label-edit x-label30" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit24">
        ...
        <div class="x-edit" xid="div23">
         <input bind-ref="mainData.ref('fBizStateName')" class="form-control" component="$UI/system/components/justep/input/input" xid="input6"></input></div> </div> </div></div>
     </div> </div> </div></div>