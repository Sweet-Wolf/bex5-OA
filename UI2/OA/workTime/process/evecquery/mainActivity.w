...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  ...
  <div class="x-control" component="$UI/system/components/justep/dateFilter/dateFilter" xid="dateFilter" filterData="mainData" dateCol="fAPPLYDATE">
   <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="gridSelect2">
    <option xid="option6"></option></div> </div><div component="$UI/system/components/justep/smartFilter/smartFilter" xid="smartFilter1" filterData="mainData" filterCols="fNO,fAPPLYPERSONNAME,fAPPLYDATE,fAPPLYDEPTNAME,fSTARTTIME,fENDTIME,fDAYS,fPERSONNEL,fBizStateName" class="x-smartFilter-clear-hide input-group"> 
   ...
   <columns xid="columns1"><column name="fBizStateName" xid="column9"></column><column name="fNO" xid="column1"></column>
  <column name="fAPPLYPERSONNAME" xid="column2"></column>
  <column name="fAPPLYDEPTNAME" xid="column4"></column><column name="fAPPLYDATE" xid="column3"></column>
  
  <column name="fSTARTTIME" xid="column5"></column>
  <column name="fENDTIME" xid="column6"></column>
  <column name="fDAYS" xid="column7"></column>
  <column name="fPERSONNEL" xid="column8"></column>
  </columns></div></div>  
