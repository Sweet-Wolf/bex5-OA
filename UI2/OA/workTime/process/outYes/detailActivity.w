...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;" xmlns:xui="http://www.justep.com/xui">  
  ...
  <div autoLoad="true" autoNew="false" columns="" component="$UI/system/components/justep/data/bizData" concept="OA_WM_outApply" directDelete="true" orderBy="" xid="mainData" xui:update-mode="merge" onValueChanged="mainDataValueChanged" onBeforeSave="mainDataBeforeSave">
   ...
   <col name="fCANCELHOLSPERSONNAME" xid="ruleCol17">
    <readonly xid="readonly17">
     <expr xid="default19">true</expr></readonly> </col> 
   <col name="fCANCELHOLSDEPTNAME" xid="ruleCol18">
   ...
   <col name="fBizStateName" xid="ruleCol19">
    <readonly xid="readonly19">
     <expr xid="default21">true</expr></readonly> </col> </rule></div></div>  
  <div xid="detailBar" component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline">
   
  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" onClick="{'operation':'mainData.save'}" xid="button1">
   <i xid="i3"></i>
   <span xid="span3"></span></a></div><div class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form" xid="mainForm">
   ...
   <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col22">
    <div class="x-label-edit x-label20" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelInput4">
     ...
     <div class="x-edit" xid="div22">
      <textarea component="$UI/system/components/justep/textarea/textarea" class="form-control" xid="textarea1" bind-ref="mainData.ref('fExplain')"></textarea></div> </div> </div>
   ...
   <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-8" xid="col23">
    <div class="x-label-edit x-label20" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelOutput6">
     <label class="x-label" style="width:100px;" xid="fPERSONNEL" bind-text="mainData.label('fPERSONNEL')"><![CDATA[]]></label>
     <div class="x-edit" xid="div23">
      <output bind-ref="mainData.ref('fPERSONNEL')" class="form-control" component="$UI/system/components/justep/output/output" data="mainData" style="float:left;" xid="fPERSONNE"></output>
      </div> </div> </div> 
   <div class="col col-xs-12 col-md-6 col-lg-4" xid="col8">
    <div class="x-label-edit x-label20" component="$UI/system/components/justep/labelEdit/labelEdit" xid="labelEdit2">
     <label class="x-label" style="width:100px;" xid="fNUMBERL" bind-text="mainData.label('fNUMBER')"><![CDATA[]]></label>
