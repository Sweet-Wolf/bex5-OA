define(function(require) {
	...
	Model.prototype.windowReceiverReceive = function(event) {
		...
		mainData.setFilter('filter1', "OA_WM_EvecApply = '" + event.data.data + "'");
		mainData.refreshData();
	};

	Model.prototype.chartBtnClick = function(event) {
		this.comp("process").showChart("/OA/workTime/process/evection/evectionProcess", this.comp("dataMain").getCurrentRowID(), null);
	};
