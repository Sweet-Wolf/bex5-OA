  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-title" xid="div2">印章管理</div>  
                      ...
                      <div xid="pdiv21" class="media-body"> 
                        ...
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col col-xs-6" xid="pcol8"> 
                            <div component="$UI/system/components/justep/output/output"
                              xid="pcrofSignatureTypeName" bind-ref="ref('fSignatureTypeName')"/> 
                          </div>  
                      ...
                      <div xid="cdiv21" class="media-body"> 
                        ...
                        <div component="$UI/system/components/bootstrap/row/row"
                          ...
                          <div class="col col-xs-6" xid="ccol8"> 
                            <div component="$UI/system/components/justep/output/output"
                              xid="ccrofSignatureTypeName" bind-ref="ref('fSignatureTypeName')"/> 
                          </div>  
