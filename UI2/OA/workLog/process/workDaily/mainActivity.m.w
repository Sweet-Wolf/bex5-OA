...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="left:18px;top:83px;height:244px;" onLoad="modelLoad">
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="false" concept="OA_WorkDaily" orderBy=""
      columns="" onSaveCommit="saveCommit" autoNew="true"> 
      <reader action="/OA/workLog/logic/action/queryOA_WorkDailyAction"/>  
      <writer action="/OA/workLog/logic/action/saveOA_WorkDailyAction"/>  
      <creator action="/OA/workLog/logic/action/createOA_WorkDailyAction"/>  
    <rule xid="rule1">
  ...
  <div xid="waitDiv" style="position:relative;height:400px;">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="button2" style="position:absolute;font-size:30px;top:42%;left:42%;" icon="icon-loading-a">
    ...
    <div class="x-panel-top"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" title="工作日报"
        class="x-titlebar"> 
        ...
        <div class="x-titlebar-title">工作日报</div>  
   ...
   <span xid="span1"></span></a>
    ...
    <div class="x-panel-content" style="display:none;" xid="dailyContent"> 
      <div component="$UI/system/components/justep/controlGroup/controlGroup"
        ...
        <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <div class="x-edit"> 
                  	  ...
                  	  data="mainData" bind-ref="mainData.ref('fFinishWork')" xid="finishWork"/>  
                    </div> 
                  </div> 
        <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit x-label30"> 
                    ...
                    <div class="x-edit"> 
 					   ...
 					   <textarea class="form-control" component="$UI/system/components/justep/textarea/textarea"
                  	  data="mainData" bind-ref="mainData.ref('fWorkPlan')" xid="workPlan"/>  
                    </div> 
                  </div> 
        <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit x-label30"> 
        ...
        <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <div class="x-edit"> 
 					   ...
 					   <textarea class="form-control" component="$UI/system/components/justep/textarea/textarea"
                  	  data="mainData" bind-ref="mainData.ref('fRemark')" xid="remark"/>  
                    </div> 
                  </div> 
        <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit x-label20"> 
                    <label class="x-label left" xid="imgURL"><![CDATA[图片]]></label>  
                    <div class="x-edit"> 
                    
                  	  <div component="$UI/system/components/justep/attachment/attachmentImage" access="duud" xid="ImgURL" bind-ref='$model.mainData.ref("fImgURL")'>
   <div class="x-attachment x-attachment-image" xid="div1">
    <div data-bind="foreach:$attachmentItems,event:{mouseover:function(){$model.$state.set('remove')},mouseout:function(){$model.$state.set('browse')}}" xid="div2">
     <img class="x-item-attachment-img" data-bind="attr:{src:$model.getPictureUrl($object)},click:$model.showInfullScreen.bind($model,$object)" xid="image1" style="width:30%;height:30%;"></img>
   ...
   <div class="x-edit" style="position:relative;height:37px;" xid="div6">
...
<span component="$UI/system/components/justep/org/orgDialog" xid="psmDialog" multiSelection="true" onReceive="psmDialogReceive" style="top:18px;left:69px;" includeOrgKind="psm"></span></div>