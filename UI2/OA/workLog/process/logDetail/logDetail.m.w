...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="workLogReportDialog" src="$UI/OA/workLog/process/workLogReport/mainActivity.m.w" process="/OA/workLog/process/workLogReport/workLogReportProcess" activity="mainActivity"></span><div xid="waitDiv" style="position:relative;height:400px;">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="button2" style="position:absolute;font-size:30px;top:42%;left:42%;" icon="icon-loading-a">
    ...
    <span xid="span3"></span></a> </div><div component="$UI/system/components/justep/panel/panel" 
    ...
    <div class="x-panel-content" xid="content1" style="display:none;"><div xid="div2" style="background-color:#2FA4E7;">
