...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;" xmlns:xui="http://www.justep.com/xui">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:626px;top:264px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="true" concept="OA_BG_ApplyM" limit="15" columns=""
  ...
  <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline" xid="toolBar">
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" label="查询" xid="filterBtn" icon="icon-android-search" onClick="{operation:'dataFilter.menu'}">
    ...
    <span xid="span13">查询</span></a><div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="statusSelect" bind-ref="mainData.ref('fBizState')" bind-labelRef="mainData.ref('fBizStateName')" style="width:100px;" multiselect="true">
   <option xid="option1" data="dStatus" value="value" label="label"></option></div> 
   
   <div component="$UI/system/components/justep/dateFilter/dateFilter" xid="dateFilter" class="x-control" filterData="mainData" filterMode="singleDate" dateCol="fCreateTime" defaultValue="all" autoRefresh="true">
   <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="gridSelect" style="width:70px;" optionHeight="390">
    <option xid="option2"></option></div> </div><div component="$UI/system/components/justep/orgFilter/orgFilter" xid="orgFilter1" class="x-control" useMyself="true" defaultValue="_myself_" autoRefresh="true" filterData="mainData" orgFIDCol="fCreatePsnFID" personIDCol="fCreatePsnFName" onFilter="orgFilterFilter" style="width:auto;">
   <div class="x-gridSelect" component="$UI/system/components/justep/org/orgSelectPC" xid="orgSelectPC1" manageCodes="badgutManagement" multiselect="true" style="width:140px;">
    <option xid="option7">
  ...
  <column name="fCostCenterCode" xid="column2"></column>
  <column name="fCostCenterName" xid="column3"></column>
  <column name="fYear" xid="column4"></column>
  
  <column name="fCreateDeptName" xid="column6"></column>
  <column name="fCreatePsnName" xid="column7"></column>
  <column name="fCreateTime" xid="column8"></column><column name="fRemark" xid="column5"></column></columns> </div><div component="$UI/system/components/justep/pagerBar/pagerBar" class="x-pagerbar container-fluid" xid="pageBar" data="mainData">
