<div 
  ...
  <div xid="dPubBaseCode" xui:update-mode="delete"/>
   <div xid="model" style="height:auto;left:332px;top:286px;"  xui:update-mode="merge"/>
    <div autoLoad="true" component="$UI/system/components/justep/data/bizData" concept="OA_Pub_BaseCode" directDelete="true" onSaveCommit="dPubBaseCodeSaveCommit" onValueChanged="dPubBaseCodeValueChanged" orderBy="fSequence asc" xid="dPubBaseCode" xui:before="dBtnStatus" xui:parent="model" xui:update-mode="insert" >
...
<![CDATA[OA_Pub_BaseCode.fScope='总账科目']]>
</filter>
<rule xid="rule2" xui:parent="dPubBaseCode" xui:update-mode="insert" >
<col name="fScope" xid="ruleCol13" >
