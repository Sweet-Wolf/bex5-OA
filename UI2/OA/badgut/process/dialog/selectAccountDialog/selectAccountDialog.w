...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:463px;top:331px;"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="false"
      xid="selectData" idColumn="OA_Pub_BaseCode" confirmDelete="false" confirmRefresh="false"> 
      <column label="id" name="OA_Pub_BaseCode" type="String" xid="default1"/> 
      <column label="编码" name="fCode" type="String"/>
      <column label="名称" name="fName" type="String"/>
    </div>  
    <div component="$UI/system/components/justep/data/bizData" xid="dialogData"
      autoLoad="true" autoNew="false" concept="OA_Pub_BaseCode" columns=""
      isTree="false"> 
      <reader action="/OA/common/logic/action/queryOA_Pub_BaseCodeAction"/> 
    <filter name="filter0" xid="filter1"><![CDATA[OA_Pub_BaseCode.fUseStatus = '1' and OA_Pub_BaseCode.fScope='总账科目']]></filter></div>
  </div>  
        ...
        <div class="col col-xs-6 col-sm-6 col-md-6 col-lg-6" xid="col1" style="height:100%;padding-left: 0;"> 
          <div class="x-bordered" style="height:100%;" xid="searchDiv"> 
            <div component="$UI/system/components/justep/dataTables/dataTables"
              ...
              lengthMenu="20"> 
              <columns> 
                <column label="编码" name="fCode"/>
                <column label="名称" name="fName"/>
              </columns> 
            </div> 
          </div> 
        </div>  
