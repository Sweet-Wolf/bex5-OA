define(function(require) {
	...
	Model.prototype.windowReceiverReceive = function(event) {
		...
		mainData.setFilter('filter1', "OA_MT_UseApply = '" + event.data.data + "'");
		mainData.refreshData();
	};

	Model.prototype.chartBtnClick = function(event) {
		this.comp("process").showChart("/OA/meeting/process/boardroomUseApply/boardroomUseApplyProcess", this.comp("dataMain").getCurrentRowID(), null);
	};
