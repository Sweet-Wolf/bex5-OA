...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:334px;top:318px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="false" autoLoad="true" concept="OA_Pub_BaseCode" onSaveCommit="saveCommit"
      limit="20" onValueChanged="mainDataValueChanged" orderBy="fSequence asc"> 
      ...
      <filter name="filter0" xid="filter1"><![CDATA[OA_Pub_BaseCode.fScope='会议室类型']]></filter>
  <rule xid="rule1">
   <col name="fName" xid="ruleCol1">
    <required xid="required1">
     <expr xid="default1">js:true</expr>
     <message xid="default6">名称必填</message></required> </col> 
   <col name="fScope" xid="ruleCol2">
    <calculate xid="calculate1">
     <expr xid="default7">'会议室类型'</expr></calculate> </col> </rule></div> 
  </div>  
  <div xid="view"> 
    <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
      ...
      <div component="$UI/system/components/justep/smartFilter/smartFilter"
        xid="smartFilter1" filterData="mainData" filterCols="fUseStatusName,fSequence,fCode,fName,fDescription"
        class="pull-right"> 
   ...
   <span xid="span12">停用</span></a></div>  
    <div component="$UI/system/components/justep/grid/grid" xid="mainGrid"
      ...
      <columns xid="column"> 
        ...
        <column name="fSequence" editable="true"> 
          <editor> 
            <input component="$UI/system/components/justep/input/input" class="form-control"
              bind-ref="ref('fSequence')"/> 
          </editor> 
        </column>  
        <column name="fCode" editable="true"> 
          <editor> 
            <input component="$UI/system/components/justep/input/input" class="form-control"
              bind-ref="ref('fCode')"/> 
          </editor> 
