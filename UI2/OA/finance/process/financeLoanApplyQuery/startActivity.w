...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;" xmlns:xui="http://www.justep.com/xui">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:626px;top:264px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="dLoanApplyQuery"
      directDelete="true" autoLoad="true" concept="OA_FC_LoanApply" limit="15" columns=""
  ...
  <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline" xid="toolBar">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" xid="refreshBtn" label="刷新" onClick="{operation:'dLoanApplyQuery.refresh'}">
    <i xid="i2"></i>
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" label="查询" xid="filterBtn" icon="icon-android-search" onClick="{operation:'dataFilter.menu'}">
    ...
    <span xid="span13">查询</span></a><div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="statusSelect" bind-ref="dLoanApplyQuery.ref('fBizState')" bind-labelRef="dLoanApplyQuery.ref('fBizStateName')" style="width:100px;" multiselect="true" onUpdateValue="statusSelectUpdateValue">
   <option xid="option1" data="dStatus" value="value" label="label"></option></div> 
   
   <div class="x-control" component="$UI/system/components/justep/dateFilter/dateFilter" xid="dateFilter2" filterData="dLoanApplyQuery" dateCol="fLoanDate">
   <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="gridSelect4">
    <option xid="option6"></option></div> </div><div component="$UI/system/components/justep/orgFilter/orgFilter" xid="orgFilter1" class="x-control" useMyself="true" defaultValue="_myself_" autoRefresh="true" filterData="dLoanApplyQuery" orgFIDCol="fLoanPsnFullID" personIDCol="fLoanPsnFullName" onFilter="orgFilterFilter" style="width:auto;">
  ...
  </div><div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" class="table table-hover table-striped" xid="listData" data="dLoanApplyQuery" rowActiveClass="active" onRowDblClick="grid3RowClick" showRowNumber="true">
   <columns xid="column">
    <column name="fBizStateName" xid="column2"></column><column name="fNO" xid="column1"></column>
  
  <column name="fLoanDeptName" xid="column3"></column>
  <column name="fLoanPsnName" xid="column4"></column>
  <column name="fLoanDate" xid="column5"></column>
  <column name="fCreateTime" xid="column6"></column>
  <column name="fReturnDate" xid="column7"></column>
  <column name="fLoanAmt" xid="column9"></column></columns> </div><div component="$UI/system/components/justep/pagerBar/pagerBar" class="x-pagerbar container-fluid" xid="pageBar" data="dLoanApplyQuery">
  ...
  <span component="$UI/system/components/justep/bizFilter/bizFilter" xid="dataFilter" filterData="dLoanApplyQuery" style="left:28px;top:290px;"></span></div>
