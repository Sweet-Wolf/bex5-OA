...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window oa" component="$UI/system/components/justep/window/window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="width:102px;height:auto;left:316px;top:83px;"
    ...
    <!--       <reader xid="default15" action="/OA/signature/logic/action/querySLSignatureAction"/>  -->  
    <!--     </div>  -->  
    <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="executorData" idColumn="fID" onCustomRefresh="executorDataCustomRefresh">
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="creatorData" idColumn="fID" onCustomRefresh="creatorDataCustomRefresh">
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="parData" idColumn="fID" onCustomRefresh="parDataCustomRefresh">
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="closeData" idColumn="fID" onCustomRefresh="closeDataCustomRefresh">
   ...
   <column name="fNo" type="String" xid="xid31"></column></div></div>  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"
        ...
        <div class="x-titlebar-title" xid="div2">借款管理</div>  
