...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;top:76px;left:43px;"
  ...
  <column label="状态名" name="fStatus" type="String" xid="xid32"></column></div>
  ...
  <column label="实到" name="fActualPersonCount" type="String" xid="xid23"></column></div>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel3">
   ...
   <div class="x-contents-content" xid="teamRecord" style="height:100%;padding:5px 5px 5px 5px;" ><div xid="waitDiv" style="position:relative;height:200px;">
  ...
  <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="scheTitleBar" style="height:40px;background-color:white;border-radius:10px;">
   ...
   <div class="x-titlebar-title" xid="title1" style="padding:0;line-height:40px;"></div>
  ...
  <!-- 考勤排行榜 -->
   <!-- <div xid="rankDiv" style="padding:0;background-color:white;border-radius:10px;margin-top:10px;"><div component="$UI/system/components/justep/row/row" class="x-row" xid="rankRow" style="padding:0px 0px 0px 0px;margin:0px 0px 0px 0px;" bind-click="rankRowClick">
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="selDeptDialog" src="./selDeptDialog.m.w" status="normal" showTitle="true" title="请选择部门" forceRefreshOnOpen="true" onReceive="selDeptDialogReceive"></span><span component="$UI/system/components/justep/windowDialog/windowDialog" xid="detailStatusDialog" src="./detailStatusDlg.m.w" showTitle="false" forceRefreshOnOpen="false"></span></div>
