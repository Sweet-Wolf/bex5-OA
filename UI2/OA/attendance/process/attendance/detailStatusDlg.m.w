...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    ...
    <div class="x-panel-content x-cards" xid="content1" style="padding-top:0;"><div component="$UI/system/components/justep/list/list" class="x-list" xid="attenStatusList" data="detailStatusDlgData" style="background-color:white;" filter=' $row.val("fStatus") == $model.params.data[0]'>
   ...
   <div class="x-col x-col-fixed x-col-center" xid="col1" style="width:auto;"><div class="x-blob" component="$UI/system/components/justep/org/orgImage" style="margin:auto;height:40px;width:40px;" xid="orgImage1" bind-ref='ref("fPersonID")' orgKind="person">
   <div class="x-blob-bar" xid="div3">
