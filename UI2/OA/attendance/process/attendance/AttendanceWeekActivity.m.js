define(function(require) {
	...
	Model.prototype.departBtnClick = function(event) {
		var data = this.params.rowID?this.params.rowID:"";
		this.comp("departDlg").open({
			"src" : "$UI/OA/attendance/process/attendance/AttendanceTimeActivity.m.w?process=/OA/attendance/process/attendance/attendanceProcess&Activity=AttendanceTimeActivity",
			"data":data
		});
	};
