...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  ...
  <column label="申诉" name="fTheState" type="String" xid="xid8"></column></div>
  </div> 
<div xid="waitDiv" style="position:relative;height:200px;">
   <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="button2" style="position:absolute;font-size:30px;top:42%;left:42%;" icon="icon-loading-a">
    ...
    <span xid="span4"></span></a> </div><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel2">
         ...
         <div component="$UI/system/components/justep/list/list" class="x-list" xid="list3" data="mianData" filter=' $row.val("fStatus") == val("value")'>
          <ul class="x-list-template" xid="listTemplateUl3">
           <li xid="li3" style="padding-left:15px;margin-top:5px;margin-bottom:5px;">
            ...
            <span xid="span5" bind-visible=" val(&quot;fStatus&quot;) =='迟到' ||'早退'" bind-text='val("fUnusualMistiming")' style="border-radius:3px;font-size:x-small;color:#FFFFFF;background-color:#FF8040;"></span>
  <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-xs" label="申诉" xid="LateAppealBtn" bind-click="LateAppealBtnClick" bind-visible=' val("fStatus") == "迟到" || val("fStatus") == "早退"'>
   <i xid="i1"></i>
   <span xid="span7">申诉</span></a>
