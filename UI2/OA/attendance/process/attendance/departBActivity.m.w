...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/data/bizData" autoLoad="true" xid="departData" concept="OA_AttendanceTime"><creator xid="default2" action="/OA/attendance/logic/action/createOA_AttendanceTimeAction"></creator>
  <reader xid="default3" action="/OA/attendance/logic/action/queryOA_AttendanceTimeAction"></reader>
  <writer xid="default15" action="/OA/attendance/logic/action/saveOA_AttendanceTimeAction"></writer></div></div>  
