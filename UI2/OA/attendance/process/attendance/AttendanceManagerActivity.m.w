...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:21px;left:21px;height:auto;" onParamsReceive="modelParamsReceive" onActive="modelActive"> 
  ...
  <column label="考勤组负责人" name="fPersonNameS" type="String" xid="xid11"></column>
  <column label="wifi名称" name="wifiName" type="String" xid="xid12"></column></div></div>  
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1"> 
      <div class="x-panel-top" xid="top1"> 
        <div component="$UI/system/components/justep/titleBar/titleBar" title="考勤组管理"
          ...
          <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="高级设置" xid="advancedSetting" onClick="advancedSettingClick">
   <i xid="i7"></i>
   ...
   <span xid="span5">新增考勤组</span></a></div><p xid="p1" style="padding:5px 5px 20px 10px;"><![CDATA[考勤规则相同的人设置到同一考勤组,方便统计]]></p>
  ...
  <span xid="fDepart" style="margin-left:10px;margin-right:10px;" bind-text='val("fDepart")'></span>
  ...
  <div xid="div8" bind-visible='val("wifiName")  != "" '><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-padding" xid="button4" icon="icon-wifi">
   <i xid="i8" class="icon-wifi"></i>
   <span xid="span6"></span></a>
  <span xid="span10" bind-text='val("wifiName")'></span></div><div xid="div7"><div component="$UI/system/components/justep/button/buttonGroup" class="btn-group btn-group-justified" tabbed="true" xid="buttonGroup1"><a component="$UI/system/components/justep/button/button" class="btn btn-link" label="修改成员及负责人" xid="undataPerson" onClick="undataPersonClick">
   <i xid="i5"></i>
  ...
  </div><a component="$UI/system/components/justep/button/button" class="btn btn-link" xid="deleteBtn" icon="linear linear-cart" style="position:absolute;right:-10px;top:0px;" onClick="deleteBtnClick">
