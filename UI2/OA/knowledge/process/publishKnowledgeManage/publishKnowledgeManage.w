...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:162px;top:256px;">
    ...
    <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar form-inline x-toolbar-spliter" xid="toolBar1" style="height:auto;">
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" onClick="openPublishKnowledgeByNew" xid="button3" label="新增" icon="icon-android-add"> 
        <i xid="i3" class="icon-android-add" />  
        <span xid="span3">新增</span>
      </a>
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" onClick="{'operation':'dKnowledge.save'}" xid="button1"> 
        <i xid="i1" />  
        <span xid="span1" />
      </a>  
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" onClick="{'operation':'dKnowledge.delete'}" xid="button2"> 
        <i xid="i2" />  
        <span xid="span2" />
      </a>  
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" onClick="{'operation':'dKnowledge.refresh'}" xid="button4"> 
        <i xid="i4" />  
        <span xid="span4" />
      </a>  
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" onClick="{'operation':'dKnowledgeFilter.menu'}" xid="button5"> 
        <i xid="i5" />  
        <span xid="span5" />
      </a>  
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" xid="btnPublish" label="发布知识" onClick="relaseKnowledge"> 
        <i xid="i6" />  
        <span xid="span6">发布知识</span>
      </a>  
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" xid="btnStopPublish" label="取消发布" onClick="cancelRelaseKnowledge"> 
        <i xid="i7" />  
        <span xid="span7">取消发布</span>
      </a>  
      <div component="$UI/system/components/justep/orgFilter/orgFilter" xid="orgFilter" class="x-control" useMyself="true" defaultValue="_myself_" autoRefresh="true" filterData="dKnowledge" orgFIDCol="fCreatePsnFID" personIDCol="fCreatePsnID"> 
        <div class="x-gridSelect" component="$UI/system/components/justep/org/orgSelectPC" xid="orgSelectPC1" manageCodes="knowledgeManagement" multiselect="true" style="width:140px;"> 
          <option xid="option3"> 
      ...
      <div class="x-control" component="$UI/system/components/justep/gridFilter/gridFilter" xid="trfFolder" filterData="dKnowledge" filterCol="fFolderID">
   <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="gridSelect2" defaultLabel="'全部'">
    <option xid="option5" data="dFolder" value="OA_KM_Folder" label="fName" appearance="tree" expandColumn="fName"></option></div> </div><div class="x-control" component="$UI/system/components/justep/gridFilter/gridFilter" xid="gdfRelaseStatus" filterData="dKnowledge" filterCol="fReleaseStatus"> 
      ...
      width="100%" onRowDblClick="grdKnowledgeRowDblClick" height="auto"> 
      <columns xid="columns3">
        <column width="100" name="recNo" xid="column14" label="序号">
          <editor xid="editor3"> 
            <input component="$UI/system/components/justep/input/input" class="form-control"
              xid="input3" bind-ref="ref('recNo')"/>
          </editor>
        </column>
        <column width="100" name="fReleaseStatusName" xid="column13" label="关注状态">
          <editor xid="editor5"> 
            <input component="$UI/system/components/justep/input/input" class="form-control"
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgPublishKnowledge"
    src="$UI/OA/knowledge/process/publishKnowledge/publishKWActivity.w" title="知识发布"
    showTitle="true" width="90%" height="90%" status="normal"/>
