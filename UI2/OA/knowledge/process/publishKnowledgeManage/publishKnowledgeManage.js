define(function(require){
	...
	Model.prototype.openPublishKnowledgeByNew = function(event){
	    ...
	    var url = "$UI/OA/knowledge/process/publishKnowledge/publishKWActivity.w?process="
				+ process + "&activity=" + activity + "&operator=new";
	...
	Model.prototype.grdKnowledgeRowDblClick = function(event){
		;
		...
		var url = "$UI/OA/knowledge/process/publishKnowledge/publishKWActivity.w?process="
				+ process + "&activity=" + activity +"&KWID="+dKnowledge.getCurrentRowID()+ "&operator=edit";
