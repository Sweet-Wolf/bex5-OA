...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div class="x-toolbar form-inline x-toolbar-spliter" component="$UI/system/components/justep/toolBar/toolBar"
    ...
    <a class="btn btn-link btn-icon-left" component="$UI/system/components/justep/button/button"
      label="缩略图" onClick="btnThumbnailClick" xid="btnThumbnail" bind-enable="canOpenRightsSet"> 
      <i xid="i5"/>  
    ...
    <div class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form"
      ...
      <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col1"> 
          ...
          <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit" xid="labelEdit3"> 
            ...
            <div class="input-group" xid="div61">
    <input component="$UI/system/components/justep/input/input" class="form-control" xid="input1" bind-ref="dKnowledge.ref('fOtherFolders')" style="border-right-style:none;"/><div class="input-group-addon" xid="div11" style="background-color:transparent;border-left-style:none;" bind-click="btnOtherFoldersClick">
  ...
  <div component="$UI/system/components/justep/controlGroup/controlGroup" class="x-control-group"
    ...
    <input component="$UI/system/components/justep/input/input" class="form-control" xid="input4" bind-ref="dKnowledge.ref('fKeyword')" style="border-right-style:none;"/><div class="input-group-addon" xid="div10" style="background-color:transparent;border-left-style:none;" bind-click="btnKeyWordClick">
        ...
        <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="formGroup9"> 
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            ...
            <div class="x-edit" xid="div51"> 
              <div component="$UI/system/components/justep/richTextarea/richTextarea"
                class="x-richTextarea" xid="richTextarea1" bind-ref="dKnowledge.ref('fContent')" style="height:300px;"/>
            </div> 
          </div> 
        </div>  
