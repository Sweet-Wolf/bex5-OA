...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="mdKnowledge"
    style="height:auto;left:143px;top:459px;" onLoad="mdKnowledgeLoad">
     <div component="$UI/system/components/justep/data/bizData" xid="dFolder"
      concept="OA_KM_Folder" autoLoad="true" isTree="true"> 
      ...
      <div class="col col-xs-9 col-sm-9 col-md-9 col-lg-9" xid="col2">
        ...
        <div component="$UI/system/components/justep/dataTables/dataTables"
          ...
          <columns xid="columns4">
            <column name="rec" xid="column22" label="序号" orderable="false"/>
