...
<div xmlns="http://www.w3.org/1999/xhtml" xmlns:xu="http://www.xmldb.org/xupdate"
  xmlns:xui="http://www.justep.com/xui" __id="id_1" extends="$UI/OA/knowledge/process/publishKnowledge/parent.w"
  component="$UI/system/components/justep/window/window" xid="window" class="window window"
  design="device:pc">  
  <div class="x-popMenu" component="$UI/system/components/justep/popMenu/popMenu"
    direction="left-bottom" xid="moreMenu" xui:parent="window" opacity="0" anchor="moreBtn"  xui:update-mode="insert"> 
