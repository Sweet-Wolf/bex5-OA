...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:369px;top:0px;">
  ...
  <div component="$UI/system/components/bootstrap/tabs/tabs" xid="tabs2"> 
    <ul class="nav nav-tabs" xid="ul2"> 
      <li class="active" xid="li3"> 
        <a content="tabContent3" xid="tabItem3">基本信息</a>
      </li>  
      <li role="presentation" xid="li4"> 
        <a content="tabContent4" xid="tabItem4">附件信息</a>
      </li> 
    </ul>  
    <div class="tab-content" xid="div2"> 
        ...
        <div component="$UI/system/components/bootstrap/row/row" class="row"
          ...
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col3"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label3" style="width:100px;" bind-text="archivalData.label('fFileNO')"/>  
              <div class="x-edit" xid="div3"> 
                <input xid="fBorrowTime" class="form-control" component="$UI/system/components/justep/input/input"
                  bind-ref="archivalData.ref('fFileNO')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col4"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label4" style="width:100px;" bind-text="archivalData.label('fArchivalNO')"/>  
              <div class="x-edit" xid="div6"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input3" bind-ref="archivalData.ref('fArchivalNO')"/>
              </div> 
            </div> 
          </div>  
          <div xid="col6" class="col col-xs-12 col-sm-6 col-md-6 col-lg-4"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label5" style="width:100px;" bind-text="archivalData.label('fSequence')"/>  
              <div class="x-edit" xid="div5"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input4" bind-ref="archivalData.ref('fSequence')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col5"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label6" style="width:100px;" bind-text="archivalData.label('fAMDate')"/>  
          ...
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col7"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label7" style="width:100px;" bind-text="archivalData.label('fMicroNO')"/>  
          ...
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col9"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label8" style="width:100px;" bind-text="archivalData.label('fPageNO')"/>  
          ...
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col8"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label9" style="width:100px;" bind-text="archivalData.label('fVoucherBegin')"/>  
              <div class="x-edit" xid="div7"> 
                <input xid="fCreatePsnName" class="form-control" component="$UI/system/components/justep/input/input"
                  bind-ref="archivalData.ref('fVoucherBegin')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col10"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label10" style="width:100px;" bind-text="archivalData.label('fVoucherEnd')"/>  
              <div class="x-edit" xid="div10"> 
                <input xid="fCreateTime" class="form-control" component="$UI/system/components/justep/input/input"
                  bind-ref="archivalData.ref('fVoucherEnd')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col16"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label18" style="width:100px;" bind-text="archivalData.label('fVoucherNum')"/>  
              <div class="x-edit" xid="div18"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input14" bind-ref="archivalData.ref('fVoucherNum')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col18"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label19" style="width:100px;" bind-text="archivalData.label('fFondsName')"/>  
              <div class="x-edit" xid="div17"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input12" bind-ref="archivalData.ref('fFondsName')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col17"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label20" style="width:100px;" bind-text="archivalData.label('fExtendStr9')"/>  
              <div class="x-edit" xid="div17"> 
                <input xid="input9" class="form-control" component="$UI/system/components/justep/input/input"
                  bind-ref="archivalData.ref('fExtendStr9')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col13"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label15" style="width:100px;" bind-text="archivalData.label('fVoucherNO')"/>  
              <div class="x-edit" xid="div14"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input11" bind-ref="archivalData.ref('fVoucherNO')"/>
              </div> 
            </div> 
          </div>  
          <div xid="col15" class="col col-xs-12 col-sm-6 col-md-6 col-lg-4"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label14" style="width:100px;" bind-text="archivalData.label('fAMLevel')"/>  
              <div class="x-edit" xid="div15"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input13" bind-ref="archivalData.ref('fAMLevel')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col12"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label13" style="width:100px;" bind-text="archivalData.label('fAMYear')"/>  
              <div class="x-edit" xid="div16"> 
                <input xid="input8" class="form-control" component="$UI/system/components/justep/input/input"
                  bind-ref="archivalData.ref('fAMYear')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col14"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label12" style="width:100px;" bind-text="archivalData.label('fSecret')"/>  
          ...
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col19"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label17" style="width:100px;" bind-text="archivalData.label('fResponsibleName')"/>  
              <div class="x-edit" xid="div12"> 
                <input xid="input6" class="form-control" component="$UI/system/components/justep/input/input"
                  bind-ref="archivalData.ref('fResponsibleName')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col20"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label16" style="width:100px;" bind-text="archivalData.label('fCarry')"/>  
          ...
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col11"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label11" style="width:100px;" bind-text="archivalData.label('fKeepLimit')"/>  
          ...
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col21"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label21" style="width:100px;" bind-text="archivalData.label('fNum')"/>  
              <div class="x-edit" xid="div21"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input16" bind-ref="archivalData.ref('fNum')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col22"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label22" style="width:100px;" bind-text="archivalData.label('fUnit')"/>  
              <div class="x-edit" xid="div20"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input15" bind-ref="archivalData.ref('fUnit')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col28"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label30" style="width:100px;" bind-text="archivalData.label('fVersionCode')"/>  
              <div class="x-edit" xid="div29"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input26" bind-ref="archivalData.ref('fVersionCode')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col30"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label31" style="width:100px;" bind-text="archivalData.label('fRoom')"/>  
              <div class="x-edit" xid="div28"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input24" bind-ref="archivalData.ref('fRoom')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col29"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label32" style="width:100px;" bind-text="archivalData.label('fChest')"/>  
              <div class="x-edit" xid="div28"> 
                <input xid="input21" class="form-control" component="$UI/system/components/justep/input/input"
                  bind-ref="archivalData.ref('fChest')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col25"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label27" style="width:100px;" bind-text="archivalData.label('fGrid')"/>  
              <div class="x-edit" xid="div25"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input23" bind-ref="archivalData.ref('fGrid')"/>
              </div> 
            </div> 
          </div>  
          <div xid="col27" class="col col-xs-12 col-sm-6 col-md-6 col-lg-4"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label26" style="width:100px;" bind-text="archivalData.label('fCreateDeptName')"/>  
              <div class="x-edit" xid="div26"> 
                <input component="$UI/system/components/justep/input/input" class="form-control"
                  xid="input25" bind-ref="archivalData.ref('fCreateDeptName')"/>
              </div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col24"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              ...
              <label class="x-label" xid="label25" style="width:100px;" bind-text="archivalData.label('fCreatePsnName')"/>  
          ...
          <div xid="col26" class="col col-xs-12 col-sm-6 col-md-6 col-lg-4"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              class="x-label-edit x-label30" xid="labelInput16"> 
              <label class="x-label" xid="label24" style="width:100px;" bind-text="archivalData.label('fCreateTime')"/>  
              <div class="x-edit" xid="div22"> 
                <input component="$UI/system/components/justep/input/input" class="form-control" xid="input19" bind-ref="archivalData.ref('fCreateTime')"></input></div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col31"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              class="x-label-edit x-label30" xid="labelInput17"> 
              <label class="x-label" xid="label29" style="width:100px;" bind-text="archivalData.label('fDescription')"/>  
              <div class="x-edit" xid="div23"> 
                <textarea component="$UI/system/components/justep/textarea/textarea" class="form-control" xid="textarea1" bind-ref="archivalData.ref('fDescription')" style="height:100px;"></textarea></div> 
            </div> 
          </div>  
          <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col32"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit"
              class="x-label-edit x-label30" xid="labelInput18"> 
              <label class="x-label" xid="label28" style="width:100px;" bind-text="archivalData.label('fRemark')"/>  
              <div class="x-edit" xid="div24"> 
                <textarea component="$UI/system/components/justep/textarea/textarea" class="form-control" xid="textarea2" bind-ref="archivalData.ref('fRemark')" style="height:100px;"></textarea></div> 
            </div> 
          </div>  
          </div> 
      </div>  
      <div class="tab-pane" xid="tabContent4">
        <div component="$UI/system/components/justep/attachment/attachmentSimple"
          access="duud" xid="attachmentSimple" bind-ref="archivalData.ref('fDocLink')"> 
          <div class="x-attachment" xid="div31"> 
            <div class="x-attachment-content x-card-border" xid="div32"> 
              ...
              <div style="clear:both;" xid="div42"/>
            </div> 
          </div> 
        </div>
      </div>
