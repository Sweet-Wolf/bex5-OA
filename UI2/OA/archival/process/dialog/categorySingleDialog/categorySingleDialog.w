...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:463px;top:331px;"> 
    <div component="$UI/system/components/justep/data/data" autoLoad="false"
      xid="selectData" idColumn="OA_AM_Category" confirmDelete="false" confirmRefresh="false"> 
      <column label="OA_AM_Category" name="OA_AM_Category" type="String" xid="xid3"></column>
  <column label="类目号" name="fCategoryNO" type="String" xid="xid1"></column>
  <column label="类目名称" name="fCategoryName" type="String" xid="xid2"></column></div>  
    <div component="$UI/system/components/justep/data/bizData" xid="dialogData"
      autoLoad="true" autoNew="false" concept="OA_AM_Category" columns="OA_AM_Category,version,fCategoryNO,fCategoryName,fUseStatus,fUseStatusName,fParentID,fSequence,fDescription,fStopDate,fCategoryURL,fCategoryURLCode,fCategoryURLName,fCreateOgnID,fCreateOgnName,fCreateDeptID,fCreateDeptName,fCreatePosID,fCreatePosName,fCreatePsnID,fCreatePsnName,fCreatePsnFID,fCreatePsnFName,fCreateTime"
      isTree="false"> 
      <reader action="/OA/archival/logic/action/queryAMCategoryAction"/> 
    <filter name="filter0" xid="filter1"><![CDATA[OA_AM_Category.fUseStatus = '1' and OA_AM_Category.fParentID='_is_root_']]></filter></div>
  </div>  
      ...
      <div component="$UI/system/components/bootstrap/row/row" class="row"
        ...
        <div class="col col-xs-6 col-md-4" xid="col4" style="height:100%;padding-left: 0;"> 
          <div component="$UI/system/components/justep/smartFilter/smartFilter"
            xid="smartFilter1" filterData="dialogData" filterCols="fCode,fName"> 
        ...
        <div class="col col-xs-6 col-sm-6 col-md-6 col-lg-6" xid="col1" style="height:100%;padding-left: 0;"> 
          <div class="x-bordered" style="height:100%;" xid="searchDiv"> 
            <div component="$UI/system/components/justep/dataTables/dataTables"
              ...
              lengthMenu="20"> 
              <columns> 
                <column name="fCategoryNO" xid="column1"></column>
  <column name="fCategoryName" xid="column2"></column>
  <column name="fDescription" xid="column3"></column></columns> 
            </div> 
          </div> 
        </div>  
          ...
          <div class="x-bordered" style="height:100%;"> 
            <div component="$UI/system/components/justep/dataTables/dataTables"
              ...
              <columns xid="columns1"> 
                <column name="fCategoryNO" xid="column6"></column>
  <column name="fCategoryName" xid="column8"></column></columns> 
            </div> 
          </div> 
        </div> 
      </div> 
