...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:550px;top:268px;" onLoad="modelLoad"><div component="$UI/system/components/justep/data/bizData" autoLoad="false" xid="dArchivalRoll" concept="OA_AM_Archival"><reader xid="default1" action="/OA/archival/logic/action/queryAMArchivalAction"></reader>
  <writer xid="default16" action="/OA/archival/logic/action/saveAMArchivalAction"></writer>
  <creator xid="default17" action="/OA/archival/logic/action/createAMArchivalAction"></creator>
  <filter name="filter0" xid="filter1"><![CDATA[OA_AM_Archival.fIsRoll=1]]></filter></div>
  
  <div component="$UI/system/components/justep/data/bizData" autoLoad="false" xid="dvFileCheck" concept="V_OA_AM_FiledCheck" orderBy="fRollName:asc,fRelevanceName:asc,fArchivalNO:asc">
   <reader xid="default6" action="/OA/archival/logic/action/queryVAMFiledCheckAction"></reader></div>
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="dBtnState" idColumn="page">
   <column label="page" name="page" type="String" xid="column1"></column>
   <column label="insertRoll" name="insertRoll" type="String" xid="column2"></column>
   <column label="insertFile" name="insertFile" type="String" xid="xid3"></column></div>
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="dFileState" idColumn="label">
   <column label="label" name="label" type="String" xid="xid4"></column>
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="dRollState" idColumn="label">
   <column label="label" name="label" type="String" xid="xid6"></column>
  ...
  <master xid="default4" data="treeData"></master></div><div component="$UI/system/components/justep/data/bizData" autoLoad="true" xid="dExcelTemp" concept="OA_AM_ExcelTemp">
   <reader xid="default9" action="/OA/archival/logic/action/queryOA_AM_ExcelTempAction"></reader>
   <writer xid="default10" action="/OA/archival/logic/action/saveOA_AM_ExcelTempAction"></writer>
   <creator xid="default11" action="/OA/archival/logic/action/createOA_AM_ExcelTempAction"></creator></div></div> 

  <span component="$UI/system/components/justep/bizFilter/bizFilter" xid="bizFilter" filterData="dArchivalRoll" style="left:653px;top:67px;"></span>
  <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row1" style="width:100%;">
   <div class="col col-xs-12 col-sm-3 col-md-3 col-lg-3" xid="col1">
  <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true" altRows="true" class="x-grid-no-bordered" xid="grdSCTree" data="treeData" appearance="tree" expandColumn="fCategoryName" useVirtualRoot="true" virtualRootLabel="档案管理" width="100%" height="auto" onRowClick="grdSCTreeRowClick">
   <columns xid="columns2"><column name="fCategoryName" xid="column20"></column>
  </columns></div>
  </div>
   <div class="col col-xs-12 col-sm-8 col-md-8 col-lg-8" xid="col2" style="overflow:auto;">
  <div component="$UI/system/components/bootstrap/tabs/tabs" xid="tabs">
   <ul class="nav nav-tabs" xid="navs">
    <li class="active" xid="nav-list">
     <a content="list" xid="tabItem1">卷管理</a></li> 
    <li role="presentation" xid="nav-detail">
     <a content="detail" xid="tabItem2">件管理</a></li> </ul> 
    ...
    <div class="tab-pane active" xid="list">
     ...
     <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true" altRows="true" class="x-grid-no-bordered" xid="grdvRollCheck" data="dArchivalRoll">
      <columns xid="columns1">
       <column width="100" name="fFileNO" xid="column3"></column>
       ...
       <column width="100" name="fVoucherNO" xid="column35"></column></columns> </div> 
     <div component="$UI/system/components/justep/pagerBar/pagerBar" class="x-pagerbar container-fluid" xid="pageBar" data="dArchivalRoll">
    ...
    <div class="tab-pane" xid="detail">
     <div xid="toolBar1" component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline">
      ...
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label" label="批量修改类目" xid="trgUpdateFile">
       <i xid="i16"></i>
       <span xid="span25">批量修改类目</span></a> </div> 
     <div class="container-fluid" xid="div13">
      <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true" altRows="true" class="x-grid-no-bordered" xid="grdvFliedCheck" data="dvFileCheck">
       <columns xid="columns3">
        <column width="100" name="fFileNO" xid="column36"></column>
        ...
        <column width="100" name="fCreateTime" xid="column50"></column></columns> </div> </div> </div> </div> </div></div>
   </div>
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgEditFile" title="件信息" src="/OA/archival/process/dialog/archivalFileDialog/archivalFileDialogForSubmit.w" showTitle="true" status="normal" width="780px" height="480px" left="423px" top="317px" style="left:69px;top:459px;"></span>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgEditRoll" src="/OA/archival/process/dialog/archivalRollDialog/archivalRollDialog.w" title="案卷信息" showTitle="true" status="normal" width="780px" height="480px" style="left:113px;top:460px;"></span>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgRollsList" src="/OA/archival/process/dialog/archivalSingleDialog/archivalSingleDialog.w" title="案卷列表" showTitle="true" status="normal" width="600px" height="370px" style="left:147px;top:472px;" onLoad="dlgRollsListLoad" onReceive="dlgRollsListReceive"></span>
  ...
  <div component="$UI/system/components/justep/excel/importExcel" xid="importExcel2" data="dExcelTemp" mappings="/UI/OA/archival/process/archivalSubmit/archivalRollImport.mapping.xml" style="left:418px;top:502px;"></div></div>