...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:334px;top:318px;"> 
    ...
    <filter name="filter0" xid="filter1"><![CDATA[OA_AM_History.fBorrowKind='原件' and OA_AM_History.fBorrowNum>OA_AM_History.fReturnNum]]></filter></div>
  </div>  
  <span component="$UI/system/components/justep/bizFilter/bizFilter" xid="bizFilter" filterData="mainData" style="left:28px;top:290px;" /><span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog" showTitle="true" status="normal" title="档案信息"></span><span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgBorrowReturn" title="档案归还" showTitle="true" status="normal" onReceive="dlgBorrowReturnReceive"></span><div xid="view"> 
    ...
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" label="归还" xid="btnReturn" icon="icon-ios7-browsers" onClick="btnReturnClick">
   <i xid="i1" class="icon-ios7-browsers"></i>
   <span xid="span7">归还</span></a>
  <div class="x-control" component="$UI/system/components/justep/dateFilter/dateFilter" xid="dateFilter2" filterData="mainData" dateCol="fBorrowTime">
   <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="gridSelect4">
    <option xid="option6"></option></div> </div><div component="$UI/system/components/justep/smartFilter/smartFilter" xid="smartFilter1" filterData="mainData" filterCols="fBorrowNum" class="x-smartFilter-clear-hide input-group"> 
   ...
   <columns xid="columns1">
    <column name="fFileNO" xid="column1"></column>
    <column name="fTitle" xid="column3" width="150"></column>
    <column name="fArchivalNO" xid="column2"></column>
    <column name="fBorrowPsnName" xid="column4"></column>
    <column name="fBorrowTime" xid="column5"></column>
    <column name="fCarry" xid="column7"></column>
    <column name="fBorrowKind" xid="column6"></column>
    <column name="fCloseTime" xid="column11"></column>
    <column name="fReturnPsnName" xid="column8"></column>
    <column name="fReturnTime" xid="column9"></column>
    <column name="fCrosserName" xid="column10"></column></columns> </div></div>  
