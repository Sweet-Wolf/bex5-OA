...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:334px;top:318px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="true" concept="OA_AM_DistoryApplyM" columns=""
      limit="20">
  ...
  <div class="x-control" component="$UI/system/components/justep/dateFilter/dateFilter" xid="dateFilter2" filterData="mainData" dateCol="fCreateTime">
   <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="gridSelect4">
    <option xid="option6"></option></div> </div><div component="$UI/system/components/justep/smartFilter/smartFilter" xid="smartFilter1" filterData="mainData" filterCols="fBizStateName" class="x-smartFilter-clear-hide input-group"> 
   ...
   <columns xid="columns1"><column name="fBizStateName" xid="column4"></column><column name="fDescription" xid="column3"></column><column name="fDistoryDate" xid="column2"></column>
  
  <column name="fCreateDeptName" xid="column5"></column>
  <column name="fCreatePsnName" xid="column6"></column>
  <column name="fCreateTime" xid="column7"></column>
  </columns></div></div>  
