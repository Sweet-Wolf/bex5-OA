  ...
  <div xid="view"> 
    <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline" xid="bar"> 
      ...
      <div component="$UI/system/components/justep/smartFilter/smartFilter"
        xid="smartFilter1" filterData="mainData" filterCols="fScope,fCode,fName,fDescription,fSequence,fUseStatusName" class="pull-right"> 
    ...
    <div component="$UI/system/components/justep/grid/grid" xid="mainGrid"
      data="mainData" width="100%" hiddenCaptionbar="true" height="auto" class="x-grid-no-bordered x-grid-title-center"> 
      <columns xid="column"> 
        <column name="fCode" editable="true" width="80"> 
          <editor> 
            <input component="$UI/system/components/justep/input/input" class="form-control"
              bind-ref="ref('fCode')"/> 
          </editor> 
        </column> 
        <column name="fName" editable="true" width="300"> 
          <editor> 
            <input component="$UI/system/components/justep/input/input" class="form-control"
              bind-ref="ref('fName')"/> 
          </editor> 
      ...
      <column name="fUseStatusName" editable="true" width="100"> 
          <editor> 
            <select component="$UI/system/components/justep/select/select" class="form-control" xid="select2" bind-ref="ref('fUseStatus')" bind-labelRef="ref('fUseStatusName')" bind-options="$model.statusData" bind-optionsValue="statusValue" bind-optionsLabel="statusName"></select></editor> 
        </column><column width="100" name="fSequence" xid="column3" editable="true"><editor xid="editor1">
    <input component="$UI/system/components/justep/input/input" class="form-control" bind-ref="ref('fSequence')" xid="input2"></input></editor></column></columns> 
    </div> 
  </div>  
