...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:290px;top:186px;">
   <div component="$UI/system/components/justep/data/bizData" xid="mainData" directDelete="true" autoLoad="true" concept="OA_AS_DiscardApply" limit="16" columns="">
  ...
  <div component="$UI/system/components/justep/orgFilter/orgFilter" xid="orgFilter2" class="x-control" useMyself="true" defaultValue="_myself_" autoRefresh="true" filterData="mainData" orgFIDCol="fApplyPsnFID" personIDCol="fApplyPsnID" style="width:auto;">
   ...
   <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" class="table table-hover table-striped" xid="listData" data="mainData" rowActiveClass="active" showRowNumber="true" onRowDblClick="listDataRowDblClick">
    <columns xid="column">
     <column name="fBizStateName" label=" 状态" width="50" xid="column1"></column>
     <column name="fNO" xid="column2"></column>
     <column name="fCode" width="120" xid="column3"></column>
     <column name="fKind" label="120" xid="column4"></column>
     <column name="fName" xid="column5"></column>
     <column name="fSpecType" xid="column6"></column>
     <column name="fApplyDeptName" xid="column7"></column>
     <column name="fApplyPsnName" xid="column8"></column>
     <column name="fApplyDate" xid="column9"></column></columns> </div> 
       ...
       <ul class="pagination" component="$UI/system/components/bootstrap/pagination/pagination" xid="pagination1">
        ...
        <li class="next" xid="li2">
         <a href="#" xid="a2">
          ...
          <span class="sr-only" xid="span9">Next</span></a> </li> </ul> </div> </div> </div> </div> </div></div>