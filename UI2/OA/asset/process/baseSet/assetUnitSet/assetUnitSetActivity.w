...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="false" xid="statusData" idColumn="statusValue" limit="-1"><column label="col0" name="statusValue" type="Integer" xid="default1"></column>
