define(function(require){
	...
	Model.prototype.modelModelConstructDone = function(event){
		...
		data.filters.setFilter("BuyApplyMFilter", "OA_OSC_BuyApplyM='" + rowID + "'");
		data.refreshData();
	...
	Model.prototype.showChart = function() {
		...
		process.showChart("/OA/officeSupplyConsumables/process/officeSupplyBuyApply/officeSupplyBuyApplyProcess", this.comp("mainData").getCurrentRowID(), null);
	};
