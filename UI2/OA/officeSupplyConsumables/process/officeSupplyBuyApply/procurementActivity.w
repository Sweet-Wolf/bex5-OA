...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:584px;top:5px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="true" autoNew="false" concept="OA_OSC_BuyApplyM"
   ...
   <readonly xid="readonly1">
    <expr xid="default3">true</expr></readonly> </rule></div>  
      ...
      <div xid="mainForm" class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form"> 
        ...
        <div xid="formGroup3" class="form-group"> 
          <div xid="col33" class="col-sm-1"> 
            <label xid="fConsultAmountL" class="control-label"><![CDATA[合计金额]]></label> 
          </div>  
        ...
        <div component="$UI/system/components/justep/controlGroup/controlGroup"
          ...
          <div> 
            <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
              xid="detailBar"> 
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
                xid="addBtn" onClick="addBtnClick" label="新建" disabled="true"> 
                <i xid="i6" class="icon-plus"/>  
                <span xid="span10">新建</span> 
              </a>  
              <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
                xid="deleteBtn" onClick="{operation:'detailData.delete'}" disabled="true"> 
                <i xid="i7"/>  
                <span xid="span11"/> 
              </a> 
            </div>  
            <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true"
              ...
              <columns xid="column"> 
                ...
                <column name="fDemandNum" label="需求数量" editable="false"> 
                ...
                <column name="fApprovalNum" xid="column2" label="审批数量" editable="false"
                  hidden="false"> 
                  <editor xid="editor2"> 
                ...
                <column name="fConsultPrice" label="参考单价" editable="false"> 
                ...
                <column name="fRemark" label="备注" editable="false" sortable="false"> 
                  <editor xid="fRemarkE"> 
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="DialogList"
    ...
    title="用品信息" showTitle="true" height="500px" status="normal" forceRefreshOnOpen="true" onReceive="DialogListReceive"> 
