...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:49px;top:262px;" onLoad="modelLoad"> 
    <div component="$UI/system/components/justep/reportData/reportData" xid="rData"> 
      <source> 
        ...
        <action id="default30" name="officeSummaryMainAction" type="action" columns="SQDSL,CYYDZQRWS,DYYDZQRWS,DAYNUM,BEGINDATE,ENDDATE"/> 
      </source> 
    </div>  
    <div component="$UI/system/components/justep/reportData/reportData" xid="rDataD"> 
      <source xid="default10"> 
        <action id="default12" name="officeSummaryDetailAction" columns="FKINDNAME,FNAME,NUM,AMOUNT"
          type="action"/> 
      </source> 
    </div>  
    <div component="$UI/system/components/justep/reportData/reportData" xid="rDCharZT"> 
      <source xid="default13"> 
        <action xid="default15" name="officeSummaryZTAction" columns="FNAME,CT"
          type="action"/> 
      </source> 
    </div>  
    <div component="$UI/system/components/justep/reportData/reportData" xid="rDCharBT"> 
      <source xid="default14"> 
        <action xid="default16" name="officeSummaryBTAction" columns="FKINDNAME,AMOUNT"
          type="action"/> 
      </source> 
    </div>  
  ...
  <column label="query" name="query" type="String" xid="default3"></column>
  <column label="dayNum" name="dayNum" type="Integer" xid="default4"></column>
  <column label="orgID" name="orgID" type="String" xid="default5"></column>
  <column label="orgName" name="orgName" type="String" xid="default7"></column></div> 
  </div>  
  <div xid="view"> 
   ...
   <label class="x-label" xid="label1"><![CDATA[统计区间]]></label>
   <div class="x-edit" xid="div1"><input component="$UI/system/components/justep/input/input" class="form-control" xid="iYear" bind-ref="dTemp.ref('beginDate')" format="yyyy-MM-dd" /></div></div></div>  
          <div class="col col-xs-2" xid="col7"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit2">
   <label class="x-label" xid="label2" style="width:30px;"><![CDATA[至]]></label>
   <div class="x-edit" xid="div2">
    <input component="$UI/system/components/justep/input/input" class="form-control" xid="input1" bind-ref="dTemp.ref('endDate')" /></div> </div></div>  
          <div class="col col-xs-3" xid="col9"> 
            <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit3">
   <label class="x-label" xid="label3" style="width:120px;"><![CDATA[预定办理周期(天)]]></label>
   <div class="x-edit" xid="div3">
    <input component="$UI/system/components/justep/input/input" class="form-control" xid="input2" bind-ref="dTemp.ref('dayNum')" /></div> </div></div>  
          <div class="col col-xs-3" xid="col16"><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30" xid="labelEdit4">
   <label class="x-label" xid="label4"><![CDATA[部门]]></label>
   <div class="x-edit" xid="div4">
    <div class="x-gridSelect" component="$UI/system/components/justep/org/orgSelectPC" xid="orgSelectPC1" bind-ref="dTemp.ref('orgID')" includeOrgKind="ogn,dpt" multiselect="true" bind-labelRef="dTemp.ref('orgName')"> 
              <div component="$UI/system/components/justep/data/bizData" autoLoad="false" xid="cOrg" limit="-1"><treeOption xid="default28"></treeOption></div>  
              <option xid="option1" value="SA_OPOrg" label="sName"> 
                <columns xid="columns1"> 
                  <column name="sName" xid="column1" /> 
                </columns> 
              </option> 
            </div></div> </div></div><div class="col col-xs-1" xid="col11"><a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="button" xid="bSearch" icon="icon-android-search" onClick="bSearchClick"> 
