...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:380px;top:216px;"
    ...
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="false" autoNew="false" concept="OA_OSC_UseApplyM"
  ...
  <div component="$UI/system/components/justep/process/process" xid="process"
    data="mainData" style="width:24px;height:5px;left:184px;top:769px;" autoStart="false"
    autoClose="false" autoSave="false" autoFilter="false"/>  
  ...
  <div xid="view"> 
    <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
      xid="processBar"> 
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
        label="流程图" xid="button1" onClick="button1Click" icon="icon-image"> 
        <i xid="i1" class="icon-image"/>  
        ...
        <div xid="formGroup2" class="form-group"> 
          ...
          <div xid="col32" class="col-sm-3"> 
            <div class="x-gridSelect" component="$UI/system/components/justep/org/orgSelectPC"
              ...
              <div component="$UI/system/components/justep/data/bizData" autoLoad="false"
                xid="dPsn" limit="-1"> 
                <treeOption xid="default2" rootFilter="1=1"/> 
              </div>  
              <option xid="option2"> 
          ...
          <div> 
            <div component="$UI/system/components/justep/grid/grid" hiddenCaptionbar="true"
              ...
              <columns xid="column"> 
                ...
                <column name="fDemandNum" label="申请数量" editable="false"> 
