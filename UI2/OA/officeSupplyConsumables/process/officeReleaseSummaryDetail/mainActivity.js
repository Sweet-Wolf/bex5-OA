	...
	Model.prototype.refreshReport = function() {
		...
		if (beginDate == "" || endDate == "") {
			...
			if (endDate < beginDate) {
				...
				sqlReport = "SELECT AD.fName AS FNAME,AM.fApplyDeptID AS FAPPLYDEPTID,AM.fApplyDeptName AS FAPPLYDEPTNAME,AD.fSpecType AS FSPECTYPE,AD.fKindName AS FKINDNAME,AD.fUnitName AS FUNITNAME,AD.fFactPrice AS FFACTPRICE,SUM(AD.fFactNum) AS FFACTNUM,SUM(AD.fFactAmount) AS FFACTAMOUNT FROM OA_OSC_UseApplyD AD JOIN OA_OSC_UseApplyM AM ON AM = AD.fMasterID AND AM.fProvideState = '1'";
				...
				sqlReport += " GROUP BY AM.fApplyDeptID,AM.fApplyDeptName,AD.fKindName,AD.fName,AD.fSpecType,AD.fUnitName,AD.fFactPrice ORDER BY AD.fKindName";
