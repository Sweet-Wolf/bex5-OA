...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:pc">  
  ...
  <div component="$UI/system/components/justep/orgFilter/orgFilter" xid="orgFilter2" class="x-control" useMyself="true" defaultValue="_myself_" autoRefresh="true" filterData="mainData" orgFIDCol="fApplyPsnFID" personIDCol="fApplyPsnID" style="width:auto;">
   ...
   <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true" rowActiveClass="active" class="table table-condensed table-hover" xid="mainTables" data="mainData" pagingType="simple_numbers" lengthMenu="10,25,50,100" onRowDblClick="orderTablesRowDblClick">
    <columns xid="column">
     ...
     <column name="fApplyReason" xid="column2"></column>
     <column name="fDemandDate" xid="column15"></column>
     <column name="fRemark" orderable="false" xid="column3"></column>
     <column name="fApplyDeptName" orderable="false" xid="column4"></column>
     <column name="fApplyPsnName" xid="column5"></column>
     <column name="fApplyDate" xid="column6"></column></columns> </div> 
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:108px;top:323px;">
   <div component="$UI/system/components/justep/data/bizData" xid="mainData" directDelete="true" autoLoad="true" concept="OA_OSC_UseApplyM" columns="" autoNew="false">
    <reader action="/OA/officeSupplyConsumables/logic/action/queryOSCUseApplyMAction" xid="default1"></reader>
    <writer action="/OA/officeSupplyConsumables/logic/action/saveOSCUseApplyMAction" xid="default2"></writer>
    <creator action="/OA/officeSupplyConsumables/logic/action/createOSCUseApplyMAction" xid="default3"></creator></div> 
