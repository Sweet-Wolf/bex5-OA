...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="personData" idColumn="fID"><column name="fID" type="String" xid="xid1"></column>
  <column name="fPersonName" type="String" xid="xid2"></column></div>
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="personIDData" idColumn="id" onCustomRefresh="personIDDataCustomRefresh"><column name="id" type="String" xid="xid11"></column>
  <column label="人员ID" name="fpersonID" type="String" xid="xid12"></column></div></div>  
      ...
      <div xid="div1">
        <div class="media" xid="media1" style="border-bottom:1px solid #dbdbdb"> 
          <div class="media-left" xid="mediaLeft1" style="height:80px;width:80px;"> 
            <div class="x-blob" component="$UI/system/components/justep/org/orgImage" style="height:60px;width:60px;" xid="personHead" orgKind="person" bind-ref='$model.personIDData.ref("fpersonID")'>
   <div class="x-blob-bar" xid="div5">
    <i class="x-blob-edit icon-compose" xid="i3"></i>
    <i class="x-blob-del icon-close-round" xid="i4"></i></div> 
   <img class="x-blob-img x-autofill" xid="image2"></img></div></div>  
      ...
      <div xid="div3">
        <div component="$UI/system/components/justep/row/row" class="x-row"
          ...
          <div class="x-col x-col-center" xid="col1" style="padding:0;font-size:0.8em;">
            <img src="$UI/OA/common/images/calendar.png" alt="" xid="image3"
          ...
          <div class="x-col x-col-center" xid="col2" style="padding:0;text-align:right;font-size:0.8em;">
            <img src="$UI/OA/common/images/time.png" alt="" xid="image4" height="20"
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="地点微调" xid="mapBtn" style="padding-left:0px;">
   <i xid="i1"></i>
   <span xid="span2">地点微调</span></a></div>
      <div xid="div2" style="padding-top:50px;">
        <img src="$UI/OA/common/images/sign.png" alt="" xid="signImage" style="display:block;margin:0 auto;width:50%;"
          bind-click="signImageClick"/>
      </div>
    </div> 
  </div>  
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="statisticsDialog" src="$UI/OA/sign/process/sign/statisticsActivity.m.w" forceRefreshOnOpen="true"></span><span component="$UI/system/components/justep/windowDialog/windowDialog" xid="detailDialog"
    src="$UI/OA/sign/process/sign/signDetailActivity.m.w" style="top:5px;left:69px;" onClose="detailDialogClose"/>
