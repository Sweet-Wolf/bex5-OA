...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="top:204px;left:66px;height:auto;" onLoad="modelLoad"> 
  </div>  
  <div component="$UI/system/components/justep/panel/panel" 
    ...
    <div class="x-panel-content x-cards" xid="content1" style="display:none;"><div xid="group">
...
<span component="$UI/system/components/justep/org/orgDialog" xid="selectPersontDialog" includeOrgKind="psm" title="选择人员" showFilter='$model.getContext().getCurrentDeptID()? ($row.val("sFID").split(".dpt/")[0] == $model.getContext().getAllPersonMemberFIDs()[0].split(".dpt/")[0]):($row.val("sFID").split(".ogn/")[0] == $model.getContext().getAllPersonMemberFIDs()[0].split(".ogn/")[0])' onReceive="selectPersontDialogReceive"></span>
