...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
   ...
   <span xid="span6">选择日期</span></a></div> 
    ...
    <div class="x-panel-content x-cards" xid="content1" style="display:none;"> 
      <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
        xid="panel3"> 
        <div class="x-panel-top" xid="top3" style="background:#eee;" height="38">
            
          
        <div xid="div3" style="padding:5px 5px 5px 15px;"><span xid="weekSpang"></span><span xid="dateSpang"/>
  </div></div>  
        <div class="x-panel-content x-cards" xid="content5">
          <div component="$UI/system/components/justep/contents/contents" class="x-contents x-full"
            active="0" xid="contents2" wrap="false"> 
            <div class="x-contents-content" xid="hasSign"><div component="$UI/system/components/justep/list/list" class="x-list" xid="signPeopleList" data="hasSignData" bind-click="signPeopleListClick">
   <ul class="x-list-template" xid="listTemplateUl1">
    <li xid="li1" style="background-color:white;margin-bottom:10px;border-bottom:1px solid #ddd;"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1">
   <div class="x-col x-col-fixed x-col-center" xid="col1" style="width:auto;padding-top:0;"><div class="x-blob" component="$UI/system/components/justep/org/orgImage" style="height:60px;width:60px;" xid="orgImage1" bind-ref='ref("fPersonID")' orgKind="person">
   <div class="x-blob-bar" xid="div2">
    <i class="x-blob-edit icon-compose" xid="i6"></i>
    <i class="x-blob-del icon-close-round" xid="i7"></i></div> 
   <img class="x-blob-img x-autofill img-circle" xid="image1"></img></div></div>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row no-padding" xid="row4">
   ...
   <span xid="span4"></span></a></div></div></li></ul> </div>
  <h2 xid="h21" bind-visible=' $model.hasSignData.count()==0' style="text-align:center;font-size:small;color:#aaa;"><![CDATA[您的团队还没有成员签到]]></h2></div>  
            <div class="x-contents-content" xid="unSign"><div component="$UI/system/components/justep/list/list" class="x-list" xid="list1" data="unSignData">
  ...
  <div component="$UI/system/components/bootstrap/row/row" class="row" xid="row5">
   <div class="col col-xs-12" xid="col9"><div class="x-blob" component="$UI/system/components/justep/org/orgImage" style="margin:auto;height:60px;width:60px;" xid="orgImage2" bind-ref='ref("fPersonID")' orgKind="person">
   <div class="x-blob-bar" xid="div1">
    <i class="x-blob-edit icon-compose" xid="i8"></i>
    <i class="x-blob-del icon-close-round" xid="i9"></i></div> 
   <img class="x-blob-img x-autofill img-circle" xid="image2"></img></div></div>
