...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad"
    ...
    <div component="$UI/system/components/justep/data/bizData" autoLoad="false"
      xid="dSchedule" concept="OA_SD_Schedule" limit="1" onBeforeSave="dScheduleBeforeSave"> 
      ...
      <rule xid="rule1"> 
        <readonly xid="readonly1"> 
          <expr xid="default19"> !(($data ? val("fCreatePsnID") : '' ) == $model.getContext().getCurrentPersonID())</expr>
        </readonly> 
        ...
        <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30"
          ...
          <div class="x-edit" xid="div5"> 
            <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect"
              ...
              onUpdateValue="gridSelect2UpdateValue"> 
  ...
  <span component="$UI/system/components/justep/org/orgDialogPC" showTitle="true"
    xid="orgDlgSingleDept" multiSelection="true" title="执行人选择" selectFilter="$row.val('sOrgKindID')==='psm'"
    onReceive="orgDlgSingleDeptReceive"/> 
</div>
