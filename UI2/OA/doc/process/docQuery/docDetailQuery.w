...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="mdDoc" style="height:auto;left:231px;top:282px;"> 
   ...
   <col name="fSignOpinion" xid="ruleCol5">
   ...
   <col name="fTemplate" xid="ruleCol7">
    ...
    <div component="$UI/system/components/justep/data/bizData" xid="dDocView"
      concept="OA_DC_Doc" orderBy="fIssueDate:desc"> 
      <reader xid="default2" action="/OA/doc/logic/action/queryOA_DC_DocAction"/> 
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
      xid="dBtn" idColumn="print"> 
      <column label="print" name="print" type="String" xid="default9"/>  
      <data xid="default10">[{"print":""}]</data> 
    </div>  
    <div component="$UI/system/components/justep/data/data" autoLoad="true"
    ...
    <div component="$UI/system/components/justep/reportData/reportData" xid="rDoc"> 
      <source xid="default14">
        <action xid="default15" name="docQueryFlowTrackAction" type="action"/>
      </source>
    </div>  
    <div component="$UI/system/components/justep/reportData/reportData" xid="rDocDetail"> 
      <source xid="default16">
        <action xid="default17" name="docQueryDetailFlowTrackAction" type="action"/>
      </source>
    </div>
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgReadeOpinion"
    ...
    showTitle="true" status="normal" width="90%" height="90%"/>
  <div component="$UI/system/components/bootstrap/tabs/tabs" xid="tabDoc" style="height:100%;width:100%;"> 
    <ul class="nav nav-tabs" xid="tabNav1"> 
      <li class="active" xid="tabDocDetail"> 
        <a content="tabContent1" xid="tabItem1"><![CDATA[详细]]></a> 
      </li>  
      <li role="presentation" xid="tabReport" bind-click="tabContent2Select"> 
    ...
    <div class="tab-content" xid="div1"> 
      <div class="tab-pane active" xid="tabContent1"> 
        <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar form-inline x-toolbar-spliter"
          ...
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="trgPrintDOMActivate" xid="btnPrint" label="打印" icon="icon-document-text"> 
            <i xid="i2" class="icon-document-text"/>  
            <span xid="span2">打印</span> 
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="trgViewRelevantDOMActivate" xid="btnViewRelevant" label="文件关联"> 
            <i xid="i3"/>  
            <span xid="span3">文件关联</span> 
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="trgReadeOpinionDOMActivate" xid="btnReadeOpinion" label="传阅情况"> 
            <i xid="i4"/>  
            <span xid="span4">传阅情况</span> 
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="{operation:'process.showChart', args:{task: 'js:$model.taskData.getCurrentRowID()'}}" xid="button2"> 
            <i xid="i5"/>  
            <span xid="span16"/>
          </a>
        <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left" onClick="{operation:'process.processRecord', args:{task: 'js:$model.taskData.getCurrentRowID()'}}" xid="button9">
   <i xid="i12"></i>
   <span xid="span7"></span></a></div>  
        <div component="$UI/system/components/justep/controlGroup/controlGroup"
          class="x-control-group" title="关联文件" xid="grdRelevance" collapsible="true"
          bind-dblclick="grdRelevanceDblclick"> 
          ...
          <div component="$UI/system/components/justep/dataTables/dataTables"
            ...
            xid="dataTables1" data="dDocView"> 
            <columns xid="columns1"> 
              <column name="fIssueDate" xid="column1" label="日期"/>  
              <column name="fTitle" xid="column2" label="文件标题"/>  
              <column name="fDocTypeName" xid="column3" label="类型"/>  
              <column name="fDocNumber" xid="column4" label="文号"/>  
              <column name="fBizStateName" xid="column5" label="状态"/>  
              <column name="fDocExigenceLevelName" xid="column6" label="快慢等级"/>  
              <column name="fDocSecretLevelName" xid="column7" label="机密程度"/>  
              <column name="fRelevanceName" xid="column8" label="文件关联"/> 
            </columns> 
          </div> 
        </div>  
        <div xid="vSendDoc" style="display:none;"> 
              ...
              <div component="$UI/system/components/bootstrap/row/row" class="row"
                ...
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col1"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label1" style="width:100px;"
                      bind-text="dDoc.label('fExtendStr1')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output1" bind-ref="dDoc.ref('fExtendStr1')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col2"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label2" style="width:100px;"
                      bind-text="dDoc.label('fDocSecretLevelName')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output2" bind-ref="dDoc.ref('fDocSecretLevelName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col3"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput3"> 
                    <label class="x-label" xid="label3" style="width:100px;"
                      bind-text="dDoc.label('fDocExigenceLevelName')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output3" bind-ref="dDoc.ref('fDocExigenceLevelName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col4"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput6"> 
                    <label class="x-label" xid="label4" style="width:100px;"
                      bind-text="dDoc.label('fOrgLetterName')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output6" bind-ref="dDoc.ref('fOrgLetterName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col6"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput5"> 
                    <label class="x-label" xid="label5" style="width:100px;"
                      bind-text="dDoc.label('fDocNumber')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output5" bind-ref="dDoc.ref('fDocNumber')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col5"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput4"> 
                    <label class="x-label" xid="label6" style="width:100px;"
                      bind-text="dDoc.label('fIssueDate')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output4" bind-ref="dDoc.ref('fIssueDate')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col5"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput4"> 
                    <label class="x-label" xid="label6" style="width:100px;"
                      bind-text="dDoc.label('fTitle')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output4" bind-ref="dDoc.ref('fTitle')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-8" xid="col5"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput4"> 
                    <label class="x-label" xid="label6" style="width:100px;"
                      bind-text="dDoc.label('fKeyword')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output4" bind-ref="dDoc.ref('fKeyword')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col5"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput4"> 
                    <label class="x-label" xid="label6" style="width:100px;"
                      bind-text="dDoc.label('fDocKindName')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output4" bind-ref="dDoc.ref('fDocKindName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col5"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput4"> 
                    <label class="x-label" xid="label6" style="width:100px;"
                      bind-text="dDoc.label('fSponsorDept')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output4" bind-ref="dDoc.ref('fSponsorDept')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col7"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelEdit1"> 
                    <label class="x-label" xid="label8" style="width:100px;"
                      bind-text="dDoc.label('fTemplate')"/>  
                ...
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col9"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label9" style="width:100px;"
                      bind-text="dDoc.label('fReason')"/>  
                ...
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col10"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label10" style="width:100px;"
                      bind-text="dDoc.label('fMainDestDept')"/>  
                ...
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col11"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label12" style="width:100px;"
                      bind-text="dDoc.label('fCopyDestDept')"/>  
                ...
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col12"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label13" style="width:100px;"
                      bind-text="dDoc.label('fDraftPerName')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output12" bind-ref="dDoc.ref('fDraftPerName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col13"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput9"> 
                    <label class="x-label" xid="label14" style="width:100px;"
                      bind-text="dDoc.label('fDraftPerPhone')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output13" bind-ref="dDoc.ref('fDraftPerPhone')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col14"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput10"> 
                    <label class="x-label" xid="label15" style="width:100px;"
                      bind-text="dDoc.label('fDraftTime')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output14" bind-ref="dDoc.ref('fDraftTime')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col17"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput11"> 
                    <label class="x-label" xid="label16" style="width:100px;"
                      bind-text="dDoc.label('fCheckPerName')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output15" bind-ref="dDoc.ref('fCheckPerName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col16"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput12"> 
                    <label class="x-label" xid="label17" style="width:100px;"
                      bind-text="dDoc.label('fCheckTime')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output16" bind-ref="dDoc.ref('fCheckTime')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col15"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput13"> 
                    <label class="x-label" xid="label18" style="width:100px;"
                      bind-text="dDoc.label('fSuperPrintPsnName')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output17" bind-ref="dDoc.ref('fSuperPrintPsnName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col20"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput14"> 
                    <label class="x-label" xid="label19" style="width:100px;"
                      bind-text="dDoc.label('fCopies')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output18" bind-ref="dDoc.ref('fCopies')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col19"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput15"> 
                    <label class="x-label" xid="label20" style="width:100px;"
                      bind-text="dDoc.label('fProofReader')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output19" bind-ref="dDoc.ref('fProofReader')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col18"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelOutput16"> 
                    <label class="x-label" xid="label21" style="width:100px;"
                      bind-text="dDoc.label('fTypePerName')"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output20" bind-ref="dDoc.ref('fTypePerName')"/> 
                  </div> 
                </div> 
              </div> 
            </div> 
          ...
          <div component="$UI/system/components/justep/controlGroup/controlGroup"
            class="x-control-group" xid="controlGroup4" title="流程环节审批人"> 
              ...
              <div component="$UI/system/components/bootstrap/row/row" class="row"
                ...
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col21"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label22" style="width:100px;">  
                      <![CDATA[部门会签人员]]>
                      </label>
                    <div class="x-edit" xid="div68"> 
                      <div component="$UI/system/components/justep/output/output"
                        class="form-control" xid="output21" bind-ref="dDoc.ref('fExtendPsnNames1')"/> 
                    </div> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col22"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <div class="x-edit" xid="div69"> 
                      <div component="$UI/system/components/justep/output/output"
                        class="form-control" xid="output22" bind-ref="dDoc.ref('fExtendPsnNames2')"/> 
                    </div> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col23"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelEdit7"> 
                    <label class="x-label" xid="label22" style="width:100px;">  
                      <![CDATA[领导签发]]>
                      </label>
                    <div class="x-edit" xid="div70"> 
                      <div component="$UI/system/components/justep/output/output"
                        class="form-control" xid="output23" bind-ref="dDoc.ref('fExtendPsnNames3')"/> 
                    </div> 
                  </div> 
                </div> 
              </div> 
              ...
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col8"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <div class="x-edit" xid="div3"> 
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control" xid="output24" bind-ref="dDoc.ref('fOrgLetterName')"/> 
                  </div> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col24"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <div class="x-edit" xid="div4"> 
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control" xid="output25" bind-ref="dDoc.ref('fOrgYear')"/> 
                  </div> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col25"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <div class="x-edit" xid="div5"> 
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control" xid="output26" bind-ref="dDoc.ref('fOrgNum')"/> 
                  </div> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col25"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <div class="x-edit" xid="div5"> 
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control" xid="output26" bind-ref="dDoc.ref('fDocExigenceLevelName')"/> 
                  </div> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col25"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <div class="x-edit" xid="div5"> 
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control" xid="output26" bind-ref="dDoc.ref('fDocSecretLevelName')"/> 
                  </div> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col25"> 
              ...
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fSponsorDept')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fSponsorDept')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fDraftPerName')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fDraftPerName')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fCheckPerName')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fCheckPerName')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fCheckTime')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fCheckTime')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fTitle')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fTitle')"/> 
                </div> 
              </div>  
              ...
              <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fMainDestDept')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fMainDestDept')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fCopyReportDept')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fCopyReportDept')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fCopyDestDept')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fCopyDestDept')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fInternalSendDeptName')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fInternalSendDeptName')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fAttachmentName')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fAttachmentName')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fTypePerName')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fTypePerName')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fProofReader')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fProofReader')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fSuperPrintPsnName')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fSuperPrintPsnName')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fCopies')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fCopies')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/justep/labelEdit/labelEdit"
                  ...
                  <label class="x-label" xid="label35" bind-text="dDoc.label('fDraftTime')"
                    style="width:100px;"/>  
                  <div component="$UI/system/components/justep/output/output"
                    class="form-control x-edit" xid="output29" bind-ref="dDoc.ref('fDraftTime')"/> 
                </div> 
              </div>  
              <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                <div component="$UI/system/components/bootstrap/row/row" class="row"
        ...
        <div xid="vReceiveDoc" style="display:none;"> 
          <h1 xid="h13" class="text-center"><![CDATA[收文审阅单]]></h1>  
          <div component="$UI/system/components/justep/controlGroup/controlGroup"
              ...
              <div component="$UI/system/components/bootstrap/row/row" class="row"
                ...
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col37"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label38" bind-text="dDoc.label('fExtendStr1')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output31" bind-ref="dDoc.ref('fExtendStr1')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fTitle')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fTitle')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fKeyword')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fKeyword')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fSourceDept')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fSourceDept')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fSourceDate')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fSourceDate')"/> 
                  </div> 
                </div>  
                ...
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fSourceDocNumber')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fSourceDocNumber')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fDocNumber')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fDocNumber')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fDocKindName')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fDocKindName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fDocExigenceLevelName')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fDocExigenceLevelName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fDocSecretLevelName')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fDocSecretLevelName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col31"> 
                ...
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fPages')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fPages')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fCopies')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fCopies')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fIssueDate')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fIssueDate')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col9"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                ...
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col9"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    class="x-label-edit" xid="labelEdit2"> 
                    <label class="x-label" xid="label9" style="width:100px;"
                      bind-text="dDoc.label('fDraftContent')"/>  
                    <div class="x-edit" xid="div53"> 
                      <textarea component="$UI/system/components/justep/textarea/textarea"
          ...
          <div component="$UI/system/components/justep/controlGroup/controlGroup"
            class="x-control-group" title="流程环节审批人" xid="controlGroup2"> 
              ...
              <div component="$UI/system/components/bootstrap/row/row" class="row"
                ...
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col40"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fExtendPsnNames1')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col40"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fExtendPsnNames2')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col40"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fExtendPsnNames3')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col40"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fExtendPsnNames4')"/> 
                  </div> 
                </div> 
              </div> 
            </div> 
                ...
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fDraftPerName')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fDraftPerName')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fDraftPerPhone')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fDraftPerPhone')"/> 
                  </div> 
                </div>  
                <div class="col col-xs-12 col-sm-6 col-md-6 col-lg-4" xid="col38"> 
                  <div component="$UI/system/components/justep/labelEdit/labelEdit"
                    ...
                    <label class="x-label" xid="label39" bind-text="dDoc.label('fDraftTime')"
                      style="width:100px;"/>  
                    <div component="$UI/system/components/justep/output/output"
                      class="form-control x-edit" xid="output32" bind-ref="dDoc.ref('fDraftTime')"/> 
                  </div> 
                </div> 
              </div> 
            </div> 
      ...
      <div class="tab-pane" xid="tabContent2"> 
        <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar form-inline x-toolbar-spliter"
          xid="toolBar2">
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="{'operation':'report1.pageSetup'}" xid="button3"> 
            <i xid="i6"/>  
            <span xid="span17"/>
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="{'operation':'report1.preview'}" xid="button4"> 
            <i xid="i7"/>  
            <span xid="span18"/>
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="{'operation':'report1.print'}" xid="button5"> 
            <i xid="i8"/>  
            <span xid="span19"/>
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="{'operation':'report1.exportPDF'}" xid="button6"> 
            <i xid="i9"/>  
            <span xid="span20"/>
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="{'operation':'report1.exportWord'}" xid="button7"> 
            <i xid="i10"/>  
            <span xid="span21"/>
          </a>  
          <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
            onClick="{'operation':'report1.exportExcel'}" xid="button8"> 
            <i xid="i11"/>  
            <span xid="span22"/>
          </a>
        </div>
  ...
  <div component="$UI/system/components/justep/process/process" xid="process"
    data="dDoc" autoFilter="false" autoClose="false" autoStart="false" autoSave="false"/>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgDocDetailQuery"
    src="$UI/OA/doc/process/docQuery/docDetailQuery.w" title="详细信息" showTitle="true"
    status="normal" width="90%" height="90%"/>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgViewRelevance"
    src="$UI/OA/doc/process/dialog/viewRelevance/viewRelevance.w" title="文件关联" status="normal"
    showTitle="true" width="90%" height="90%" onClose="dlgViewRelevanceClose" onReceive="dlgViewRelevanceReceive"/>
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgSendDocRpt"
    src="$UI/OA/doc/process/reportDoc/sendReportDoc/sendDocRptActivity.w" title="发文打印"
    showTitle="true" status="normal" width="90%" height="90%"/>
