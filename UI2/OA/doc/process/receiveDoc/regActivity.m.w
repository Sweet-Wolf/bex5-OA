...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window oa" component="$UI/system/components/justep/window/window"
  design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:206px;top:433px;"
        ...
        xid="panel3"> 
          ...
          <div component="$UI/system/components/justep/output/output" class="x-output content-data content-row"
           ...
           <div component="$UI/system/components/justep/labelEdit/labelEdit"
            ...
            <label class="x-label" xid="label1"><![CDATA[摘要：]]></label>  
            <div class="x-edit" xid="div1_2"> 
              <div component="$UI/system/components/justep/output/output" class="form-control x-output text-right"
                xid="output2" bind-ref="taskData.ref('sContent')" /> 
            </div> 
          </div> 
           
       
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            class="x-label-edit x-label30 oa-input-group-row" xid="startLabelInput"> 
          ...
          <div component="$UI/system/components/justep/labelEdit/labelEdit"
            class="x-label-edit x-label30 oa-input-group-row" xid="endLabelInput"> 
