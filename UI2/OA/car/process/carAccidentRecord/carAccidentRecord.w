...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:204px;top:225px;">
    <div component="$UI/system/components/justep/data/bizData" xid="mainData"
      directDelete="true" autoLoad="true" concept="OA_CA_AccidentRecord" limit="10" columns=""
      autoNew="false" onSaveCommit="dataSaveCommit" orderBy="fAccidentTime desc"> 
    ...
    <calculateRelation relation="recordNO" xid="calculateRelation1" type="Integer" label="序号"></calculateRelation>
  <rule xid="rule1">
   <col name="recordNO" xid="ruleCol1">
    <calculate xid="calculate1">
     <expr xid="default5">index() + 1</expr></calculate> </col> </rule></div>
  </div>  
  <div component="$UI/system/components/justep/toolBar/toolBar" class="x-toolbar x-toolbar-spliter form-inline"
    ...
    <div component="$UI/system/components/justep/smartFilter/smartFilter" xid="smartFilter"
      filterData="mainData" filterCols="fCode,fName,fType,fCarKindName,fAccidentDeptName,fAccidentPerName,fAccidentTime,fAccidentSite,fAcccidentBurden,fWoundedDetail" class="pull-right"> 
  ...
  <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true"
    ...
    <columns xid="column">
      <column name="recordNO" xid="column1" label="序号"></column><column name="fCode" label="车牌号"/>
      <column name="fName" label="品牌"/>
      <column name="fType" label="型号"/>
      <column name="fCarKindName" label="车辆类型"/>
      <column name="fAccidentDeptName" label="肇事单位"/>
      <column name="fAccidentPerName" label="肇事人"/>
      <column name="fAccidentTime" label="肇事时间"/>
      <column name="fAccidentSite" label="肇事地点"/>
      <column name="fAcccidentBurden" label="事故责任"/>
      <column name="fWoundedDetail" label="伤亡情况"/>
    </columns> 
  </div>  
