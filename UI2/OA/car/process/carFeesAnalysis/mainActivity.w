...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:pc">  
 ...
 <SQL id="default1"> 
          ...
          <DB2 id="default5"/>  
          <SYBASE id="default6"/> 
        </SQL>      <action xid="default10" type="action" name="queryOA_CA_FeesregisterReportAction"></action></source> 
    </div> 
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="dTemp" idColumn="year"><rule xid="rule2">
   ...
   <col name="month2" xid="ruleCol3">
    <required xid="required3">
     ...
     <message xid="default19"></message></required> </col> </rule>
  <column label="年" name="year" type="Integer" xid="default1"></column>
  ...
  <data xid="default4">[{&quot;year&quot;:{&quot;value&quot;:&quot;&quot;},&quot;month1&quot;:{&quot;value&quot;:&quot;&quot;},&quot;month2&quot;:{&quot;value&quot;:&quot;&quot;}}]</data></div>
  ...
  <div xid="view"> 
   ...
   <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-12" xid="col13"><div component="$UI/system/components/bootstrap/row/row" class="row" xid="row1">
  ...
  <div class="col col-xs-2" xid="col8"><div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="sltMonth1" bind-ref="dTemp.ref('month1')" bind-labelRef="dTemp.ref('month1')">
   <option xid="option1" data="dMonth1" value="value" label="label"></option></div></div>
  <div class="col col-xs-1" xid="col9"><label class="control-label" xid="controlLabel3"><![CDATA[---]]></label></div>
  <div class="col col-xs-2" xid="col10"><div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="gridSelect2" bind-ref="dTemp.ref('month2')" bind-labelRef="dTemp.ref('month2')">
   <option xid="option2" data="dMonth2" value="value" label="label"></option></div></div>
