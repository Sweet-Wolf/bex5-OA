...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:pc">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:375px;top:168px;" onModelConstructDone="modelModelConstructDone"> 
   ...
   <readonly xid="readonly1">
    <expr xid="default4">js:getCurrentRow() &amp;&amp;  val(&quot;fUseStatus&quot;) == '1'</expr></readonly> 
   <col name="fCode" xid="ruleCol1">
    <required xid="required1">
     <expr xid="default5">undefined</expr>
     <message xid="default6"></message></required> </col> 
   <col name="fName" xid="ruleCol2">
    <required xid="required2">
     <expr xid="default7">undefined</expr>
     <message xid="default8"></message></required> </col> 
   <col name="fDrivingLicence" xid="ruleCol3">
    <required xid="required3">
     <expr xid="default9">undefined</expr>
     <message xid="default10"></message></required> </col> </rule></div>  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
              ...
              <div class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form"
                ...
                <div class="form-group" xid="formGroup1"> 
                  ...
                  <div class="col-sm-2" xid="col6"> 
                    <label class="control-label" bind-text='$model.dCarDriverInfo.label("fName")'
                      xid="controlLabel1"/> 
                  </div>  
                ...
                <div class="form-group" xid="formGroup3"> 
                  ...
                  <div class="col-sm-4" xid="col13"> 
                    <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="gridSelect1" bind-ref="dCarDriverInfo.ref('fSex')" bind-labelRef="dCarDriverInfo.ref('fSex')">
   <option xid="option1" data="sexData" value="sex" label="sex"></option></div></div>  
                ...
                <div class="form-group" xid="formGroup5"> 
                  ...
                  <div class="col-sm-4" xid="col21"> 
                    <div class="x-gridSelect" component="$UI/system/components/justep/gridSelect/gridSelect" xid="fCarKindName" bind-ref="dCarDriverInfo.ref('fCarKindID')" bind-labelRef="dCarDriverInfo.ref('fCarKindName')">
   <option xid="option2" data="dCarKind" value="fCode" label="fName"></option></div></div>  
   ...
   <div class="col-sm-2" xid="col39">
                    <label class="control-label" bind-text=' $model.dCarDriverInfo.label("fRemark")' xid="controlLabel15" />
                  </div><div class="col-sm-10" xid="col40">
                    <textarea component="$UI/system/components/justep/textarea/textarea" class="form-control" xid="fRemark" bind-ref="dCarDriverInfo.ref('fRemark')"></textarea></div></div>
  </div> 
            </div>  
