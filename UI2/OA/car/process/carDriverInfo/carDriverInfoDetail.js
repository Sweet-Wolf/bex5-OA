define(function(require) {
	...
	Model.prototype.modelModelConstructDone = function(event){
		...
		var dCarDriverInfo = this.comp('dCarDriverInfo');
		if (operator === "new"){
			dCarDriverInfo.newData();
		}else{
			dCarDriverInfo.filters.setFilter("carDriverInfoFilter", "OA_CA_DriverBasicInfo='" + id + "'");
			dCarDriverInfo.refreshData();	
		}
