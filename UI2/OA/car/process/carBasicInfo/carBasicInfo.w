...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:-28px;top:488px;">
    ...
    <calculateRelation relation="carBasicNO" xid="calculateRelation1" label="排序" type="Integer"></calculateRelation>
  <rule xid="rule1">
   <col name="carBasicNO" xid="ruleCol1">
  ...
  <div component="$UI/system/components/justep/dataTables/dataTables" flexibleWidth="true"
    ...
    <columns xid="column">
      <column name="carBasicNO" xid="column1" label="序号"></column><column name="fUseStatusName" label="启用标识" /><column name="fCode" label="编码"/>
