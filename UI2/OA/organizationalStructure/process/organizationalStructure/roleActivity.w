...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
   ...
   <div class="x-col x-col-33" xid="col4"><img src="$UI/OA/organizationalStructure/process/organizationalStructure/img/leader.jpg" alt="" xid="image1" style="width:100%;"></img></div>
  ...
  <h4 xid="h42"><![CDATA[I am the leader]]></h4></div>
   ...
   <div class="x-col x-col-33" xid="col7">
    <img src="$UI/OA/organizationalStructure/process/organizationalStructure/img/directors.jpg" alt="" xid="image2" style="width:100%;"></img></div> 
   ...
   <div class="x-col x-col-33" xid="col9">
    <img src="$UI/OA/organizationalStructure/process/organizationalStructure/img/staff.jpg" alt="" xid="image3" style="width:100%;"></img></div> 
