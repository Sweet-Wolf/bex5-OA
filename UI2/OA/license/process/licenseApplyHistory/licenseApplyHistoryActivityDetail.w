...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:pc;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:99px;top:458px;"> 
    <div component="$UI/system/components/justep/data/bizData" xid="dLicenseView"
      concept="OA_LS_LicenseView"> 
  ...
  <div component="$UI/system/components/justep/excel/exportExcel" xid="exportExcel" from="UI" data="dLicenseView"></div><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    xid="panel1"> 
    <div class="x-panel-content" xid="content1"> 
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-icon-left"
        label="导出excel" xid="button2" onClick="{operation:'exportExcel.exportExcel'}"> 
        <i xid="i4"/>  
        <span xid="span5"/>
      </a>  
        ...
        <div class="form-horizontal container-fluid" component="$UI/system/components/bootstrap/form/form"
          ...
          <div class="form-group" xid="formGroup1"> 
            ...
            <div class="col-sm-10" xid="col2">
              <div component="$UI/system/components/justep/output/output" class="form-control"
                xid="output9" bind-ref="dLicenseView.ref('fNO')"/>
            </div> 
          </div>  
          <div class="form-group" xid="formGroup2"> 
            ...
            <div class="col-sm-4" xid="col8"> 
              <div component="$UI/system/components/justep/output/output" class="form-control x-output"
    ...
    <div class="x-panel-bottom" xid="bottom1"> 
      ...
      <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-label x-dialog-button"
        xid="button1" onClick="{operation:'dLicenseView.refresh'}"> 
        <i xid="i3"/>  
