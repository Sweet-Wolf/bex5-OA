...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" design="device:pc;">  
  ...
  <div xid="view"> 
    ...
    <div class="x-control" component="$UI/system/components/justep/dateFilter/dateFilter" xid="dateFilter1" filterData="mainData" dateCol="fCreateTime" defaultValue="all">
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="dlgLicenseApplyHistoryDetail"
    ...
    status="normal" title="证照借用详细信息" showTitle="true" width="70%" height="80%"/>
</div>
